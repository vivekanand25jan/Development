...
$con=mysql_connect('localhost','deeptis','gu4u4ApEd');
mysql_select_db('deeptis_stayaway');
...
$sql = "SELECT DISTINCT city FROM api_hotels_city WHERE `city` LIKE '$input%' ORDER BY city LIKE '$input,%' DESC, pref,city ASC";
