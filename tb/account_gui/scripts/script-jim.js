	 ...
	 var newRow = rowItem.html()
		...
		setTimeout(function(){
			$('.new-row').fadeIn(800, function() {
				$(".latest-searches-list").load("http://devweb/2012/airfast_tickets/web/el/hotels .latest-searches-list", function() {
...
function page_cars(){
	...
	var aClass 		= "cars"
	var ajaxUrl 	= "/2012/airfast_tickets/web/ajax.php?ajax=1"
	...
	$('.field-remove').live('click', function(){
	 ...
	 var newRow = rowItem.html()
		...
		setTimeout(function(){
			$('.new-row').fadeIn(800, function() {
				$(".latest-searches-list").load("http://devweb/2012/airfast_tickets/web/el/cars .latest-searches-list", function() {
					//removeItem(); //calling same function onSuccess
