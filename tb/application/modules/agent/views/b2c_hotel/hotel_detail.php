...
<?php } }
    ...
    <div class="hotel_right_panel">
    	<?php
										...
										?>	
<div style="float:left; margin:0 0 15px 0;"><a href="javascript:void(0);" class="home_link">Home</a> > <a href="javascript:void(0);" class="home_link"><?php echo $city[1]; ?></a> > <a href="javascript:void(0);" class="home_link"><?php echo 'greater '.$city[0]; ?></a> > <a href="<?php echo WEB_URL.'hotel/backtosearch'; ?>" class="home_link"><?php echo 'search results for '.$city[0]; ?></a> > <a href="javascript:void(0);" class="home_link"><?php echo 'Hotel Detail'; ?></a></div> <br /><br />
      ...
      <div class="right_cont_right_panel">
        <div class="search_res"><a href="<?php echo WEB_URL.'hotel/backtosearch'; ?>">Back to Search Results</a></div>
      </div>
      <!-- step photo starts -->
...
for($t=0;$t< count($room_info);$t++)
{
  ...
  <tr>
    ...
    <td  class="table_colom2"><?php echo $room_info[$t]->total_cost.' USD'; ?></td>
    <td  class="table_colom2"><?php echo $room_info[$t]->status; ?></td>
    <td  class="table_colom2"><a href="<?php echo WEB_URL.'hotel/pre_booking/'.$room_info[$t]->api_temp_hotel_id; ?> "><input type="submit" value="Book Now" /></a></td>
  </tr>
...
for($tt=0;$tt< count($merge_inclsuion);$tt++)
{
  ...
  <tr>
    ...
    <td><a href="<?php echo WEB_URL.'hotel/pre_booking/'.$merge_result_id; ?> "><input type="submit" value="Book Now" /></a></td>
  </tr>
