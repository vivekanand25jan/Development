...
$(document).ready(function () {
	...
	$('#hotel_facility input, #price_asc, #price_desc, #star_asc, #star_desc, #name_asc, #name_desc').click(function () {
		...
		var map_data = $.ajax({
					'async': false,
				  url:"<?php echo WEB_URL; ?>hotel/fetch_map_data/",
				  data: "",
...
Map
	...
	<li>
		...
		<ul>
			...
			<li><a href="javascript:void(0);"  id="star_asc" oonclick="javascript:return  hotel_fac_sorting('star_asc')" >1star to 5star</a></li>

			<li><a href="javascript:void(0);"  id="star_desc" oonclick="javascript:return  hotel_fac_sorting('star_desc')">5star to 1star</a></li>
	...
	<li>
		...
		<ul>
			...
			<li><a href="javascript:void(0);"  id="name_asc" oonclick="javascript:return  hotel_fac_sorting('name_asc')">A to Z</a></li>
			<li><a href="javascript:void(0);"  id="name_desc" oonclick="javascript:return  hotel_fac_sorting('name_desc')">Z to A</a></li>
