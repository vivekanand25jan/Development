...
<script type="text/javascript" src="<?php echo WEB_DIR ?>script/jquery.js"></script>
				   ...
				   <span style="float:left; width:100px; font-weight:bold;"> Last Credit </span>         :  <?php if (isset($last_credit)) echo '$' . $last_credit; ?><br/>
								<?php endif;?>
                                    ...
                                    <div class="left_pannel_body">
                                    		<div class="wi159">Lorum spam</div>
                                         
                                      <div class="wi159">
                                          <div class="arrow">
                                            	<div class="arrow_down"></div>
                                                <div class="wi120">Lorum spam</div>
                                            	</div>
                                    ...
                                    <div class="change_search_pannel">
                                    	<div class="change_pannel_header">Lorum spam</div>
                                        <div class="left_pannel_body">
...
<div class="print_view_btn"><img src="<?php echo WEB_DIR ?>images/print.jpg" width="200" height="34" onclick="func_shw();" style="cursor:pointer;" /></div>
