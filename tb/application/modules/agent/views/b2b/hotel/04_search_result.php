...
$(document).ready(function () {
	...
	//var a = ['hotelsbed_pre','travco','gta','hotelsbed'];
	//var a = ['hotelsbed_pre','travco','gta','hotelsbed'];
	var a = ['gta'];
	  var i = 0;
	  $('#loading').fadeIn();
	  ...
	  function nextCall() {
		...
		//	$('#price').slider('refresh');
			...
			// Paging 
			loadData(1);
			//$("#roomfac").load("<?php print WEB_URL ?>b2b_hotel/room_fac");
			$("#hotelfac").load("<?php print WEB_URL ?>b2b_hotel/hotel_fac");
		  },
	...
	function hotel_fac_sorting()
		...
		//loadData(1); 
		  // Make AJAX call
		  $("#result").load("<?php print WEB_URL ?>b2b_hotel/hotel_fac_sorting/"+finval);
		
		//$("#result_count").empty().html('<img src="<?php echo WEB_DIR ?>gui/images/ajax-loader.gif" width="16" height="16" />');
		$("#result_count").load("<?php print WEB_URL ?>b2b_hotel/room_fac_sorting_count/"+finval);
		...
		function loading_show(){
						...
						var params = 'val='+finval+'&page='+page;
                          ...
                          $.ajax
                            ({
                                type: "POST",
                                url: "<?php echo WEB_URL.'b2b_hotel/pagination_call_room_fac'; ?>",
                                 data: params,
                                 success: function(msg)
                                {
                                    $(".pagination").ajaxComplete(function(event, request, settings)
...
{
		$.ajax({
				  url:'<?php echo WEB_URL; ?>b2b_hotel/asc_order_price_new',
...
{
		$.ajax({
				  url:'<?php echo WEB_URL; ?>b2b_hotel/desc_order_price_new',
					  ...
					  function loading_show(){
						...
						var params = 'page='+page;
                          ...
                          $.ajax
                            ({
                                type: "POST",
                                url: "<?php echo WEB_URL.'b2b_hotel/pagination_call_desc'; ?>",
                                 data: params,
                                 success: function(msg)
                                {
                                    $(".pagination").ajaxComplete(function(event, request, settings)
...
{
		$.ajax({
				  url:'<?php echo WEB_URL; ?>b2b_hotel/asc_order_name_new',
					  ...
					  function loading_show(){
						...
						var params = 'page='+page;
                          ...
                          $.ajax
                            ({
                                type: "POST",
                                url: "<?php echo WEB_URL.'b2b_hotel/pagination_name_asc'; ?>",
                                 data: params,
                                 success: function(msg)
                                {
                                    $(".pagination").ajaxComplete(function(event, request, settings)
...
{
		$.ajax({
				  url:'<?php echo WEB_URL; ?>b2b_hotel/asc_order_star_new',
					  ...
					  function loading_show(){
						...
						var params = 'page='+page;
                          ...
                          $.ajax
                            ({
                                type: "POST",
                                url: "<?php echo WEB_URL.'b2b_hotel/pagination_star_asc'; ?>",
                                 data: params,
                                 success: function(msg)
                                {
                                    $(".pagination").ajaxComplete(function(event, request, settings)
...
{
		$.ajax({
				  url:'<?php echo WEB_URL; ?>b2b_hotel/desc_order_star_new',
					  ...
					  function loading_show(){
						...
						var params = 'page='+page;
                          ...
                          $.ajax
                            ({
                                type: "POST",
                                url: "<?php echo WEB_URL.'b2b_hotel/pagination_star_desc'; ?>",
                                 data: params,
                                 success: function(msg)
                                {
                                    $(".pagination").ajaxComplete(function(event, request, settings)
	...
	function name_rating_desc()
{
		...
		$.ajax({
				  url:'<?php echo WEB_URL; ?>b2b_hotel/desc_order_name_new',
					  ...
					  function loading_show(){
						...
						var params = 'page='+page;
                          ...
                          $.ajax
                            ({
                                type: "POST",
                                url: "<?php echo WEB_URL.'b2b_hotel/pagination_name_desc'; ?>",
                                 data: params,
                                 success: function(msg)
                                {
                                    $(".pagination").ajaxComplete(function(event, request, settings)
  ...
  // Make AJAX call
 // $("#result").load("<?php print WEB_URL ?>b2b_hotel/asc_order_price_new");
  ...
  <script type="text/javascript" src="<?php echo WEB_DIR ?>gui/ajax/ajaxsbmt.js"></script>
      ...
      if (window.XMLHttpRequest)
        ...
        xmlhttp.open("POST","<?php print WEB_URL ?>b2b_hotel/all_filter_new1_desc/"+id,true);
        xmlhttp.send();
      ...
      if (window.XMLHttpRequest)
        ...
        xmlhttp.open("POST","<?php print WEB_URL ?>b2b_hotel/all_filter_name_asc/"+id,true);
        xmlhttp.send();
      ...
      if (window.XMLHttpRequest)
        ...
        xmlhttp.open("POST","<?php print WEB_URL ?>b2b_hotel/all_filter_name_desc/"+id,true);
        xmlhttp.send();
      ...
      if (window.XMLHttpRequest)
        ...
        xmlhttp.open("POST","<?php print WEB_URL ?>b2b_hotel/all_filter_star_asc/"+id,true);
        xmlhttp.send();
      ...
      if (window.XMLHttpRequest)
        ...
        xmlhttp.open("POST","<?php print WEB_URL ?>b2b_hotel/all_filter_star_desc/"+id,true);
        xmlhttp.send();
      ...
      if (window.XMLHttpRequest)
        ...
        xmlhttp.open("POST","<?php print WEB_URL ?>b2b_hotel/all_filter_new1_facility/"+id+"/"+value,true);
        xmlhttp.send();
                                     ...
                                     <!-- <div class="wi159">
                                      ...
                                      <!--<div class="wi159">
                                       ...
                                       <div class="hotel_cover">
                                         	<div class="check_box_cover"><input type="checkbox" name="hotel_fac_val" onclick="javascript:hotel_fac_sorting()"  value="wi-fi" id="1" /></div>
...
Map
	...
	<li>
		...
		<ul>
			<li><a  href="<?php echo WEB_URL.'b2b_hotel/currency_convertion/USD'; ?>">USD</a></li>
			<li><a   href="<?php echo  WEB_URL.'b2b_hotel/currency_convertion/GBP'; ?>">GBP</a></li>
            <li><a   href="<?php echo  WEB_URL.'b2b_hotel/currency_convertion/AUD'; ?>">AUD</a></li>
			<li><a  href="<?php echo  WEB_URL.'b2b_hotel/currency_convertion/THB'; ?>">THB</a></li>
