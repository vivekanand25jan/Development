                    ...
                    <form  name="leftfilter"  id="hotels-results-form">
                    		<div class="left_pannel">
                                    ...
                                    <div class="left_pannel_body">
                                    		<div class="wi159"><a id="reset_filter" href="">Reset Filters </a></div>
                                     ...
                                     <!-- <div class="wi159">
                                      ...
                                      <!--<div class="wi159">
                                       ...
                                       <div class="hotel_cover">
                                            ...
                                            <div class="hotel_cover47">Wi-Fi88</div><div class="wi56"></div>
                                         </div>
                                         <div class="hotel_cover">
...
Map
	...
	<li>
		<a href="javascript:void(0);">Price</a>
        	<ul>
			<li><a href="javascript:void(0);"  id="price_asc">Low To high</a></li>

			<li><a href="javascript:void(0);"  id='price_desc'>High To Low</a></li>
		</ul>
	</li>
	...
	<li>
		...
		<ul>
			<li><a href="javascript:void(0);"  id="star_asc">1star to 5star</a></li>

			<li><a href="javascript:void(0);"  id="star_desc">5star to 1star</a></li>
		</ul>
	</li>
	<li>
		...
		<ul>
			<li><a href="javascript:void(0);"  id="name_asc" >A to Z</a></li>
			<li><a href="javascript:void(0);"  id="name_desc" >Z to A</a></li>
		</ul>
