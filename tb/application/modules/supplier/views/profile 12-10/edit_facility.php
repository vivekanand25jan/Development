...
<div id="result">
		...
		<table>
		<tr><td>
		<form name="f2" action="<?php echo WEB_URL;?>index/acc_facility" method="post">
		<table>
			<tr>
			...
			<tr>
				...
				<td><input type="hidden" name="hide_prop_id" id="hide_prop_id" value="<?php echo $this->uri->segment(3)?>"></td>
			</tr>
		</table>
	</form>
	</td>
	...
	<form name="f2" action="<?php echo WEB_URL;?>index/acc_facility" method="post">
		<table>
			...
			<tr>
				...
				<td><input type="submit" name="add_new" id="add_new" value="Add"></td>
				<td><input type="hidden" name="hide_prp_id" id="hide_prp_id" value=<?php echo $id ?>>
			</tr>
		</table>
	</form>
	</td></tr>
	<tr><td>
<form name="f3" action="<?php echo WEB_URL;?>index/insert_facility" method="post">		
				...
				{
					$chk=in_array($value->facility_name,$list_selected_item);
					if($chk)
					{
						$mychk="Checked";
					}
				...
				<tr>
				<td>
					<input type="checkbox" name="hotel_facility[]" id="<?php echo $value->facility_id ?>" value="<?php echo $value->facility_name ?>"   <?php echo $mychk?>/><?php echo $value->facility_name ?>
				</td>
				</tr>	
				<?php
				}
		...
		<td>
				...
				{
					$chk_room=in_array($value->space_fac_name,$list_selected_item);
					if($chk_room)
					{
						$mychk_hotel="Checked";
					}
				...
				<tr>
				<td>
					<input type="checkbox" name="hotel_facility[]" id="<?php echo $value->space_fac_id ?>" value="<?php echo $value->space_fac_name ?>"  <?php echo $mychk_hotel?>><?php echo $value->space_fac_name ?>
				</td>
				</tr>	
				<?php
				}
