...
<div class="panes">
  ...
  <div id="containerdount"  class="tab1" style="padding-top:30px; margin-top:20px;">
   ...
   <?php if(isset($result[0]->sup_detailedlocation_id)){ ?>
    <form action="<?php echo WEB_URL; ?>index/edit_detail_location/<?php echo $result[0]->sup_detailedlocation_id; ?>" method="post">
    <?php } else { ?>
    <form action="<?php echo WEB_URL; ?>index/set_detail_location" method="post">
    <?php } ?>
    <table width="100%" border="0" cellspacing="1" cellpadding="0">
    <tr>
    <td>Location (detailed location)<br /><textarea name="location" cols="50" rows="5"><?php if(isset($result[0]->location)) echo $result[0]->location; ?></textarea><span style="color:#FF0000;"> <?php echo form_error('location');?></span></td>
    <td>&nbsp;</td>
