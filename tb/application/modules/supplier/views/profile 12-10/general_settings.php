...
//echo "welcome.:<br>";
//print_r($result);exit;
//echo $result->sup_apart_generalsettings_id;
//exit;
?>
...
<div id="result">
	...
	?>
	<?php if(isset($result->sup_apart_generalsettings_id)){ ?>
	<form name="f1" action="<?php echo WEB_URL;?>index/edit_general_set/<?php echo $result->sup_apart_generalsettings_id ?>" method="post">
	<?php } else { ?>
	<form name="f1" action="<?php echo WEB_URL;?>index/add_general_set" method="post">
	<?php }?>
		<BR>
		<BR>
		<table>
        ...
        <?php 
            ...
            if (substr($display, 0, 2) == '00') { 
				...
				<option value="<?php echo $display; ?>" <?php if(isset($result->checkinfrom ) && $display == $result->checkinfrom ){ echo "selected='selected'"; } ?>><span style="color:#FF0000;"> <?php echo form_error('check_in_time_from');?><?php echo $display; ?></option>
				<?php
				}?>
				</td>
				<td>To</td>
        ...
        <?php 
            ...
            if (substr($display, 0, 2) == '00') { 
				...
				<option value="<?php echo $display; ?>" <?php if(isset($result->checkoutfrom) && $display == $result->checkoutfrom){ echo "selected='selected'"; } ?>><?php echo $display; ?><span style="color:#FF0000;">  <?php echo form_error('check_out_time_from');?></option>
				<?php
				}?>
				</td>
				<td>To</td>
			...
			<?php 
				...
				if (substr($display, 0, 2) == '00') { 
					...
					<option value="<?php echo $display; ?>" <?php if(isset($result->checkoutto) && $display == $result->checkoutto){ echo "selected='selected'"; } ?>><?php echo $display; ?><span style="color:#FF0000;">  <?php echo form_error('check_out_time_to');?></option>
					<?php
					}?>
					</td>
			</tr>
			<tr>
				<td><font color="orange">Check-in/Check-Out Automation: </font></td>
			</tr>
			<tr>
				<td>Automatically check-in guest after</td>
				<td><input type="text" name="guest_in_time" id="guestin__time" value="<?php if(isset($result->checkin_after)){ echo $result->checkin_after;}?>"> hours </td>
			</tr>
			<tr>
				<td>Automatically check-out guest after</td>
				<td><input type="text" name="guest_out_time" id="guest_out_time" value="<?php if(isset($result->checkout_after)){ echo $result->checkout_after;}?>"> hours </td>
			</tr>
			<tr>
			...
			<tr>
				<td><font color="orange">Taxes: </font></td>
			</tr>
			<tr>
				<td>State:</td>
				<td>
