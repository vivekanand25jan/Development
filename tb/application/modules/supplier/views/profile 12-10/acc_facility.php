...
<form name="f3" action="<?php echo WEB_URL;?>index/insert_facility" method="post">		
		...
		<td>
				...
				<tr>
				<td>
					<input type="checkbox" name="room_facility[]" id="<?php echo $value->space_fac_id ?>" value="<?php echo $value->space_fac_name ?>" <?php echo $mychk_hotel?> /><?php echo $value->space_fac_name ?>
				</td>
				</tr>	
				<?php
				}
