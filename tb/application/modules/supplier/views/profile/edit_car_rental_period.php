...
<div class="panes">
  ...
  <div style="float:right; height:25px;"><a href="<?php echo site_url('index/car_rental/')?>/<?php echo $this->uri->segment(3); ?>" style="color:#099;">Back</a></div>
    ...
    <div style="font-weight:normal; float:left; margin-left:20px; font-size:16px;">Car Rental Period Information</div>
    <br />
    <div style="float:left; margin-left:20px; clear:both;">
    
    <form action="<?php echo WEB_URL; ?>index/edit_car_period/<?php echo $hotel_id; ?>/<?php echo $id; ?>" method="post">
	...
	?>
    <td><input value="<?php echo $from_date; ?>" name="from_date" id="datepicker"  onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox"  style=" background-image: url('<?php echo WEB_DIR; ?>images/b2b-calicon.png');   background-repeat: no-repeat;  background-position: right center;" /> 
  ...
  <tr height="35">
    ...
    <td><input  value="<?php echo $to_date; ?>" name="to_date" id="datepicker1" onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox" style=" background-image: url('<?php echo WEB_DIR; ?>images/b2b-calicon.png');   background-repeat: no-repeat;  background-position: right center;" />&nbsp;&nbsp;
