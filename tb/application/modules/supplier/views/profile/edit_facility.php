...
<li><a href="<?php echo WEB_URL;?>index/insert_facility/<?php echo $this->uri->segment(3)?>" id="tabs_active">Accommodation Facilities </a></li>
...
<div id="result">
		...
		<table>
		<tr><td>
		<form name="f2" action="<?php echo WEB_URL;?>index/add_hotel_facility/<?php echo $this->uri->segment(3)?>" method="post">
		<table>
			<tr>
	...
	<td>
	<form name="f2" action="<?php echo WEB_URL;?>index/acc_room_facility/<?php echo $this->uri->segment(3)?>" method="post">
		<table>
			<tr>
	...
	<tr>
    <td>
    <form name="f3" action="<?php echo WEB_URL;?>index/set_acco_fecilities/<?php echo $this->uri->segment(3)?>" method="post">		
   		<table>
    <?php
    ...
    <td>
        ...
        <?php if($sup_hotel_faci = $this->Supplier_Model->supplier_hotel_facilities($this->uri->segment(3), $facility_iist[$i]->sup_fac_id)) { echo "checked='checked'"; } ?> />			<?php echo $facility_iist[$i]->facility_name ?>
    </td>
    </tr>	
    <?php
    }
    ...
    if(isset($room_fac_list) && $room_fac_list!='')
    {
        if(isset($room_fac_list[0]->sup_fac_id))
        {
            ...
            <td>
                ...
                <?php if($sup_room_faci = $this->Supplier_Model->supplier_room_facilities($this->uri->segment(3), $room_fac_list[$i]->sup_fac_id)) { echo "checked='checked'" ; } ?>/><?php echo $room_fac_list[$i]->facility_name ?>
            </td>
            </tr>	
            <?php
            }
    ...
    <tr><td colspan="2" align="center"><input type="image" src="<?php echo WEB_DIR ?>images/save-but.png"/></td></tr>
    </form>
	</table>
</div>
