...
<li><a href="<?php echo WEB_URL;?>index/edit_property_info/<?php echo $this->uri->segment(3)?>" id="tabs_active"> Hotel Information </a></li>
...
<?php
	...
	{
?>
		<form action="<?php echo WEB_URL;?>index/update_property_inform/<?php echo $this->uri->segment(3); ?>" name="f1" method="post">
   <?php
   }
	else
	{ 
   ?>
		<form action="<?php echo WEB_URL;?>index/add_property_inform/<?php echo $this->uri->segment(3)?>" name="f1" method="post">
  <?php
	}
?>
	<div style="width:770px; float:center;padding:5px;  margin-top:20px;" >
		<td style="float:left; color:#F60;">
		 Hotel Information 
	</div>
	<div>
        <table width="780px" align="center" cellspacing="5px" cellpadding="5px" border="0" bordercolor="#ededed" >
          ...
          <tr>
           <td style="padding-left:11px;">Latitude:  <!--<a href="http://itouchmap.com/latlong.html"  target="_blank" style="color:#099;">http://itouchmap.com/latlong.html</a>--></td>
			<td style="padding-left:11px;r"><input type="text" name="latitude" id="lat" size="30" value="<?php if(isset($prop_inf->latitude)){ echo $prop_inf->latitude; }?> " /></td>
          </tr>
          <tr>
           <td style="padding-left:11px;">Longitude:  <!--<a href="http://itouchmap.com/latlong.html" target="_blank" style="color:#099;">http://itouchmap.com/latlong.html</a>--></td>
			<td style="padding-left:11px;r"><input type="text" name="longitude" id="lng" size="30" value="<?php if(isset($prop_inf->longitude)){ echo $prop_inf->longitude; }?>"></td>
          </tr>
          </table>
          <div style="width:650px; height:400px; margin-left:200px; margin-bottom:20px;" id="map_canvas">
          </div>
         
          <table width="780px" align="center" cellspacing="5px" cellpadding="5px" border="0" >
		  <tr>
