...
<table width="942" border="0" align="left" cellpadding="0" cellspacing="0"  >
  <tr>
    <td align="right" valign="top" class="" colspan="5" height="30"><a href="<?php echo site_url('index/add_car_rental')?>/<?php echo $this->uri->segment(3)?>/<?php echo $car_period->sup_car_rental_period_id; ?>" style="color:#099; font-weight:bold;">Add Car Rental</a></td>
  </tr>
   <tr>
