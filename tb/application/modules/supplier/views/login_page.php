...
<body>
<?php $this->load->view('header_index'); ?>
<div class="midlebody">
          ...
          <tr>	
          	<td width="480" valign="top" style="border-right:2px dashed #989898;">
            	...
            	<table width="480" align="center" border="0" cellpadding="4" cellspacing="2">
                    <tr>
                      <td colspan="2" class="right-hotel-name" style=" font-size:25px; font-weight:normal; color:#243419; padding-top:0px; padding-bottom:15px">New Supplier, Register Here</td>
                    </tr>
...
<?php echo form_error('name');?></td>
					...
					<tr>
                      <td>&nbsp;</td>
                      <td><input  name="terms" type="checkbox" id="checkbox" />&nbsp;Supplier Terms & Condition
