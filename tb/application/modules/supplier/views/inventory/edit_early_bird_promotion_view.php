...
else
{
  ...
  <form name="AddEarlyBirdPromotion" action="<?php echo WEB_URL; ?>index/edit_early_bird_plan/<?php echo $this->uri->segment(3); ?>//<?php echo $allot_details->sup_inv_cat_early_bird_id; ?>" method="post">
  
  <div style="float:right; height:25px; margin-top:10px;"><a href="<?php echo site_url('index/early_bird/')?>/<?php echo $this->uri->segment(3); ?>" style="color:#099;">Back</a></div>
 	<div style="margin-top:20px;">
     
     <div style="margin-left:20px;" >
     <table width="630" border="0" cellspacing="1" cellpadding="0"><caption><h4 align="left">Early Bird Promotion</h4></caption>
    ...
    <tr height="35">
                ...
                <td width="20%">
					...
					<?php
                    $cate = $this->Supplier_Model->supplier_cate_types($this->uri->segment(3));
    ...
    <div style="font-weight:normal; float:left; margin-left:20px; font-size:16px;"></div>
    <br />
    <div style="float:left; margin-left:20px;">
    <table width="100%" border="0" cellspacing="1" cellpadding="0">
...
else
{
        ...
        ?>
            <input value="<?php echo $fdate; ?>" name="sd" id="datepicker"  onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox"  style=" background-image: url('<?php echo WEB_DIR; ?>images/b2b-calicon.png');   background-repeat: no-repeat;  background-position: right center;" /> 					
            To <input  value="<?php echo $tdate; ?>" name="ed" id="datepicker1" onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox" style=" background-image: url('<?php echo WEB_DIR; ?>images/b2b-calicon.png');   background-repeat: no-repeat;  background-position: right center;" /></td>
    </tr>
    ...
    <td><input value="<?php echo $book_date; ?>" name="bb" id="datepicker2"  onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox"  style=" background-image: url('<?php echo WEB_DIR; ?>images/b2b-calicon.png');   background-repeat: no-repeat;  background-position: right center;" /></td>
    </tr>
    </table>
