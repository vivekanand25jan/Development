...
<div class="panes">
  ...
  <div id="containerdount"  class="tab1" style="padding-top:40px;">
     ...
     <div style="float:right; height:25px;"><a href="<?php echo site_url('index/view_allotment_list/')?>/<?php echo $this->uri->segment(3); ?>" style="color:#099;">Back</a></div>
   
    <div style="float:left; margin-left:20px;">
    
    
    <form name="form1" action="<?php echo WEB_URL; ?>index/add_allotment_plan/<?php echo $this->uri->segment(3); ?>" method="post">
        ...
        <tr height="35">
            ...
            <select name='season' id='season' style="width:150px;">
                ...
                for($i=0;$i<count($season_list);$i++){
                 ?>
                 <option value="<?php echo $season_list[$i]->season_id; ?>"><?php echo $season_list[$i]->season ?></option>
                <?php	
                }
          ...
          <tr> 
            ...
            <tr height="35">
                ...
                <td width="639"><input type="text" id="allocation_rooms" name="allocation_rooms" value="" /><span style="color:#FF0000;"> <?php echo form_error('allocation_rooms');?></span></td>
            </tr>
            
            <tr height="35">
                <td>Release Period:</td>
                <td><input type="text" id="allocation_release_days" name="allocation_release_days" value="" size="5"/>&nbsp;days&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="allocation_release_period" name="allocation_release_period" value="" size="5"/>&nbsp;hrs
    ...
    else
    {
            ...
            <tr height="35">
                <td>Validity From:</td>
                <td><input name="sds" id="datepicker" value=""  onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox"  style=" background-image: url('<?php echo WEB_DIR; ?>images/b2b-calicon.png');background-repeat:no-repeat;background-position:right center;width:100px; height:18px;"/> &nbsp; 
                	To <span id="out"><input name="eds" value="" id="datepicker1" onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox" style=" background-image: url('<?php echo WEB_DIR; ?>images/b2b-calicon.png'); background-repeat:no-repeat;background-position:right center;width:100px; height:18px;"/></span></td>
            </tr></table></td>
            </tr>
