...
<style>
#lightbox{ background:url(<?php echo WEB_DIR; ?>images/overlay.png); width:100%; height:100%; display:none; z-index:99999; background-position:left; position:absolute; top:0%; left:13%;}
body{
margin-top:0px;
...
<tr><td valign="middle"><div align="right" style="background-color:#FFF; border:solid 2px #069; width:984px; margin:0px auto; position: fixed; top:30px; left:10%; height:auto">
<a href="javascript:void(0);" onClick="$('#light_box').attr('src','');$('#lightbox').hide();" class="ac_det"><div align="right" style="color:#069; font-size:14px; height:14; width:14; padding:5px 5px 0px 10px; " ><img border="0" src="<?php echo WEB_DIR ?>images/Close-button1.png" height="15px" width="55" style="padding:5px 5px 0px 10px; float:right;"/>&nbsp;&nbsp;&nbsp;</div></a>
<iframe src="" id="light_box" name="light_box" frameborder="0" width="100%" height="575px" scrolling="yes" style="background-color: #FFFFFF"></iframe></div></td></tr></table></div>
<script type="text/javascript">
$(document).ready(function(){
	
    $('#addplanrate').each(function(){
		
    var url = $(this).attr('href') + '?TB_iframe=true&height=600&width=960';
    $(this).attr('href', url);
     });
 }); 
...
$("#rows1").append('<table><tr><td style="width:183px;"></td><td>&nbsp;</td><td style="width:120px;"><input name="sd[]" id="sdate" type="text" class="b2b-txtbox"  style="width:100px; height:18px;"/></td><td>&nbsp;</td><td style="width:120px;"><input id="edate" name="ed[]" type="text" class="b2b-txtbox"  style="width:100px; height:18px;"/></td><td style="width:20px;"></td><td colspan="3"></td><td colspan="2" align="left"></td></tr></table>');
...
$(document).ready(function(){
	...
	//alert(ed1);
	$.post( "<?php print WEB_URL ?>index/getAvailDates", {mmsd:sd1, mmed:ed1, rate_id:<?php echo $this->uri->segment(4); ?>, selectedDays:selectedDays},
      function(data) {
		if(data != ''){
			$("#filtering").show();
			$("#monthDates").html('');
...
function getDates(){
	...
	$.post( "<?php print WEB_URL ?>index/getAvailDates", {mmsd:sd1, mmed:ed1, rate_id:<?php echo $this->uri->segment(4); ?>, selectedDays:selectedDays, da:'days'},
      function(data) {
		  //alert(data);
		if(data != ''){
			$("#filtering").show();
...
$("#rows").append('<table><tr><td><div style="padding-top:2px; margin-left:-32px;font-size:13px;">DayPrior: <input type="text" name="cancel_policy_nights[]" id="cancel_policy_nights[]" size="3" />&nbsp;Charge<input type="text" name="cancel_policy_percent[]" size="5"/>% &nbsp;or<input type="text" name="cancel_policy_charge[]" size="5"/>Night Charge&nbsp; From<input type="text" name="cancel_policy_from[]" size="7"/> &nbsp;To<input type="text" name="cancel_policy_to[]" size="7"/></div></td></tr></table>');
...
<div class="panes">
    ...
    else
    {
            ...
            <tr height="35">
                ...
                <?php /*?><select name="no_of_adults" id="no_of_adults" style="width:150px;">
                    ...
                    <span style="color:#FF0000;"> <?php echo form_error('adult');?></span></td>
            </tr>
            <tr height="35">
                <td>Child: </td>
                <td>
          ...
          <input type="checkbox" id="dinner" name="dinner" value="Dinner"/>Dinner  &nbsp;
			...
			else if($rat_tac_details->meal_plan == '1')
			{?>
 ...
 Supplement Rate:<input type="text" name="supplement_rate" size="5" value="<?php if(isset($rat_tac_details->supplement_rate) && $rat_tac_details->supplement_rate != '0') echo $rat_tac_details->supplement_rate; ?>"/>amt
          ...
          <!--  <tr>
                <td></td>
                <td id="meanPlanRates" style="font-size:13px; display:none;">
              <br />   
           Breakfast Type: <input type="text" name="breakfast_type" value="<?php echo $rat_tac_details->breakfast_type; ?>" />
           <br />
           Adult Meal Rates:- Breakfast:<input type="text" name="adult_meal_plan_breakfast_rate"  value="<?php echo $rat_tac_details->adult_meal_plan_breakfast_rate; ?>" size="5"/>amt,
           ...
           &nbsp; Dinner:<input type="text" name="adult_meal_plan_dinner_rate"  size="5" value="<?php echo $rat_tac_details->adult_meal_plan_dinner_rate; ?>"/>amt    
             ...
             Child Meal Rates:- Breakfast:<input type="text" name="child_meal_plan_breakfast_rate" size="5" value="<?php echo $rat_tac_details->child_meal_plan_breakfast_rate; ?>"/>amt,
           &nbsp; Lunch:<input type="text" name="child_meal_plan_lunch_rate" size="5" value="<?php echo $rat_tac_details->child_meal_plan_lunch_rate; ?>"/>amt,
           &nbsp; Dinner:<input type="text" name="child_meal_plan_dinner_rate"  size="5" value="<?php echo $rat_tac_details->child_meal_plan_dinner_rate; ?>"/>amt    
                </td>
            </tr>
            <tr>
                <td></td>
    ...
    <td width="100">To</td>
    <td width="10"></td>
    <td width="260"><strong>Day</strong> <span style="float:right;"><input name="all_day" id="all_day" type="checkbox" value="" onclick="return check_all();" /> <strong>Check All</strong></span></td>
    <td colspan="2" style="border-bottom:solid 0px #666">
        ...
        <td style="width:220px;"> Room Available Dates:
            ...
            ?>
        <td style="width:100px;"><input value="<?php echo $fdate; ?>" name="sd[]" id="sdate"  onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox"  style=" background-image: url('<?php echo WEB_DIR; ?>images/b2b-calicon.png');background-repeat:no-repeat;background-position:right center;width:100px; height:18px;"/></td>
        <td >&nbsp;</td>
        
        <td  style="width:100px;"><span id="out"><input value="<?php echo $tdate; ?>" name="ed[]" id="edate" onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox" style=" background-image: url('<?php echo WEB_DIR; ?>images/b2b-calicon.png'); background-repeat:no-repeat;background-position:right center;width:100px; height:18px;"/>
        </span></td>
    ...
    <a  class="thickbox" href="<?php echo site_url('index/add_rate_plan_view_again/')?>/<?php echo $this->uri->segment(3); ?>/<?php echo $rat_tac_details->season_id; ?>/<?php echo $rat_tac_details->category_type; ?>" id="addplanrate"  title="Add Season">
     <img src="<?php echo WEB_DIR; ?>images/plus.png"  style="border:0px;"/>
        ...
        <td colspan="3" id="day">
            <input name="day" id="dayy" type="checkbox" value="Mon" style="margin-right:3px;"/>Mon &nbsp; 
            <input name="day" id="dayy" type="checkbox" value="Tue" style="margin-right:3px;"/>Tue &nbsp;
            <input name="day" id="dayy" type="checkbox" value="Wed" style="margin-right:3px;"/>Wed &nbsp;
            <input name="day" id="dayy" type="checkbox" value="Thu" style="margin-right:3px;"/>Thu<br />
            <input name="day" id="dayy" type="checkbox" value="Fri" style="margin-right:3px;"/>Fri &nbsp;
            <input name="day" id="dayy" type="checkbox" value="Sat" style="margin:3px 6px;"/>Sat &nbsp;
            <input name="day" id="dayy" type="checkbox" value="Sun" style="margin-right:3px;"/>Sun
                     </td>
  ...
  $.ajax({
  		...
  		success: function(data)
		{
  			...
  			if(data != "")
		    {
				...
				{
				//alert(data.can_policies[i].cancel_policy_nights);
					$("#rows").append('<table><tr><td><div style="padding-top:2px; margin-left:-32px;font-size:13px;">DayPrior: <input type="text" name="cancel_policy_nights[]" id="cancel_policy_nights[]" size="3" value="'+data.can_policies[i].cancel_policy_nights+'" /> Charge<input type="text" name="cancel_policy_percent[]" value="'+data.can_policies[i].cancel_policy_percent+'" size="5"/>% &nbsp;or<input type="text" name="cancel_policy_charge[]" value="'+data.can_policies[i].cancel_policy_charge+'" size="5"/>Night Charge&nbsp;  From<input type="text" name="cancel_policy_from[]" value="'+data.can_policies[i].cancel_policy_from+'" size="7"/> &nbsp;To<input type="text" name="cancel_policy_to[]" value="'+data.can_policies[i].cancel_policy_to+'" size="7"/></div></td></tr></table>');
				}
			}
