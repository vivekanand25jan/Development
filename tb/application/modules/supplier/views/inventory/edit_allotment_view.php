...
<div class="panes">
  ...
  <div id="containerdount"  class="tab1" style="padding-top:40px;">
    ...
    <form name="form1" action="<?php echo WEB_URL; ?>index/edit_allotment_plan/<?php echo $this->uri->segment(3); ?>/<?php echo $allot_details->sup_inv_cate_allotment_ref_id; ?>" method="post">
    ...
    else
    {
            ...
            <tr height="35">
                <td>Validity From:</td>
                <td><input name="sds" id="datepicker" value="<?php echo $fdate; ?>"  onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox"  style=" background-image: url('<?php echo WEB_DIR; ?>images/b2b-calicon.png');background-repeat:no-repeat;background-position:right center;width:100px; height:18px;"/> &nbsp; 
                	To <span id="out"><input name="eds" value="<?php echo $tdate; ?>" id="datepicker1" onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox" style=" background-image: url('<?php echo WEB_DIR; ?>images/b2b-calicon.png'); background-repeat:no-repeat;background-position:right center;width:100px; height:18px;"/></span></td>
            </tr></table></td>
            </tr>
