    ...
    else
    {
            ...
            <tr height="35">
                ...
                <td><select name="no_of_adults" id="no_of_adults" style="width:150px;">
                      ...
                      <option value="1" <?php if(isset($rat_tac_details->adult) && $rat_tac_details->adult == '1'){ echo "selected='selected'"; } ?>>1</option>
                      <option value="2" <?php if(isset($rat_tac_details->adult) && $rat_tac_details->adult == '2'){ echo "selected='selected'"; } ?>>2</option>
                      <option value="3" <?php if(isset($rat_tac_details->adult) && $rat_tac_details->adult == '3'){ echo "selected='selected'"; } ?>>3</option>
                      <option value="4" <?php if(isset($rat_tac_details->adult) && $rat_tac_details->adult == '4'){ echo "selected='selected'"; } ?>>4</option>
            ...
            <tr height="35">
                ...
                <td><select name="no_of_childs" id="no_of_childs" style="width:150px;">
                      ...
                      <option value="0" <?php if(isset($rat_tac_details->child) && $rat_tac_details->child == '0'){ echo "selected='selected'"; } ?>>0</option>
                      <option value="1" <?php if(isset($rat_tac_details->child) && $rat_tac_details->child == '1'){ echo "selected='selected'"; } ?>>1</option>
                      <option value="2" <?php if(isset($rat_tac_details->child) && $rat_tac_details->child == '2'){ echo "selected='selected'"; } ?>>2</option>
                      <option value="3" <?php if(isset($rat_tac_details->child) && $rat_tac_details->child == '3'){ echo "selected='selected'"; } ?>>3</option>
                    </select>&nbsp; Below <input type="text" id="child_below_age" name="child_below_age" value="<?php if(isset($rat_tac_details->child_below_age) && $rat_tac_details->child_below_age!='')echo $rat_tac_details->child_below_age; ?>" size="5"/> age<span style="color:#FF0000;"> <?php echo form_error('child');?></span></td>
            </tr>
            <tr height="35">
                <td>&nbsp; </td>
...
<!--                <select name="cancel_policy_nights[]" id="cancel_policy_nights[]" style="width:60px;">
    ...
    <td style="width:250px;"> Room Available Dates:
        ...
        <?php
            ...
            $next_dte = date("d-m-Y",strtotime("+8 days"));
        ?>
    <td style="width:120px;"><input name="sd[]" id="sdate"  onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox"  style=" background-image: url('<?php echo WEB_DIR; ?>images/b2b-calicon.png');background-repeat:no-repeat;background-position:right center;width:100px; height:18px;"/></td>
    <td >&nbsp;</td>
    <td  style="width:120px;"><span id="out"><input name="ed[]" id="edate" onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox" style=" background-image: url('<?php echo WEB_DIR; ?>images/b2b-calicon.png'); background-repeat:no-repeat;background-position:right center;width:100px; height:18px;"/></span></td>
