...
function getDates(){
	...
	//alert(document.form1.day.length);
	for(var i=0; i < document.form1.day.length; i++){
		//alert(document.form1.day[i].value);
      ...
      function(data) { //alert(data);
		if(data != ''){
			...
			for(var i=0; i<data.count_days; i++){
				...
				$("#monthDates").append('<tr style="border-top:solid 1px #deab6f; border-bottom:solid 1px #deab6f; padding-bottom:2px;"><td  style="border-right:solid 1px #deab6f; text-align:left; width:10%;font-size:11.5px;" id="tdtd">'+data.dates[i]+'<input type="hidden" name="dates[]" value="'+day[0]+'"><input type="hidden" name="weekday[]" value="'+day[1]+'"></td><td style="border-right:solid 1px #deab6f; text-align:center; width:10%;" id="tdtd3"><input name="price[]" type="text" class="input-field"  style="height:20px;  background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->rate;?>"/></td><td style="border-right:solid 1px #deab6f; text-align:center; width:10%;" id="tdtd3"><input name="extra_bed_price[]" type="text" class="input-field"  style="height:20px;  background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->extra_bed_price;?>"/></td><td style="border-right:solid 1px #deab6f; text-align:center; width:10%;" id="tdtd3"><input name="avail[]" type="text" class="input-field"  style="height:20px;  background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->available_rooms;?>"/></td><td style="border-right:solid 1px #deab6f; text-align:center; width:10%;" id="tdtd3"><input name="adult[]" type="text"  id="adult[]" class="input-field"  style="height:20px;  background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->adult;?>"/></td><td style="border-right:solid 1px #deab6f; text-align:center; width:10%;" id="tdtd3"><input name="child[]" type="text"  id="child[]" class="input-field"  style="height:20px;  background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->child;?>"/></td><td></td><td style="border-right:solid 1px #deab6f; text-align:center; width:10%;" id="tdtd3"><input name="child_price[]" type="text" class="input-field"  style="height:20px;  background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->child_charge;?>"/></td><td style="border-right:solid 1px #deab6f; text-align:center; width:10%;" id="tdtd3"><input name="infant[]" type="text" class="input-field"  style="height:20px;  background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->infant;?>"/></td><td style="border-right:solid 1px #deab6f; text-align:center; width:11%;" id="tdtd3"><input name="sup_charge[]" type="text" class="input-field"  style="height:20px;  background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->supplementary_charge_rate;?>"/></td><td style="border-right:solid 1px #deab6f; text-align:center; width:9%;" id="tdtd3">&nbsp;</td></tr>');
			}
		}
		else
		{
...
//alert(xx);
alert("datepickeram" + (id1-2) + "_1");
alert("hid_sd" + (id1-2) + '_1');
document.getElementById("hid_sd" + (id1-2) + '_1').value=selectedDate;
 }
*/
			});
...
id = parseInt(cnt) + 1;
			id1 = id + 1;
$("#rows").append('<table><tr><td><div style="padding-top:2px; margin-left:-32px;font-size:13px;">DayPrior: <input type="text" name="cancel_policy_nights[]" id="cancel_policy_nights[]" size="3" /> Charge<input type="text" name="cancel_policy_percent[]" size="4"/>% &nbsp;or<input type="text" name="cancel_policy_charge[]" size="4"/>Night Charge&nbsp; From<input type="text" name="cancel_policy_from[]" id="datepickercm' + id1 + '_1" size="7"/><input type="hidden"  id="c_from' + id1 + '_1" /> &nbsp;To<input type="text" name="cancel_policy_to[]" id="datepickerdm' + id1 + '_1" size="7"/><input type="hidden"  id="c_to' + id1 + '_1" /></div></td></tr></table>');
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <td width="77%"><select name="market_id[]" id='market_id' style="width:150px;" multiple="multiple" required>
               ...
               <?php
                ...
                if(isset($market[0]->market_id))
                    ...
                    ?>
                      <option value="<?php echo $market[$i]->market_id; ?>"<?php if(isset($results[0][0]->market_id) && $results[0][0]->market_id == $market[$i]->market_id){ echo "selected='selected'"; } ?>><?php echo $market[$i]->market_name; ?></option>
                    <?php	
                    }
                    }
                    ?>          
            ...
            <td width="77%"><select name='season' id='season' style="width:150px;">
               ...
               <?php
                ...
                if(isset($cate[0]->season_id))
                    ...
                    ?>
                      <option value="<?php echo $cate[$i]->season_id; ?>"<?php if(isset($results[0][0]->season_id) && $results[0][0]->season_id == $cate[$i]->season_id){ echo "selected='selected'"; } ?>><?php echo $cate[$i]->season;?></option>
                    <?php	
                    }
                    }
                    ?>          
            ...
            <tr height="35">
                ...
                <td><select name="category_name" id="category_name" style="width:150px;">
                    ...
                    for($i=0;$i<count($cate);$i++){
                    ?>
                       <option value="<?php echo $cate[$i]->sup_inv_cate_type_id; ?>"  <?php if(isset($results[0][0]->category_type) && $results[0][0]->category_type == $cate[$i]->sup_inv_cate_type_id){ echo "selected='selected'"; } ?>><?php echo $cate[$i]->cate_type.' '.$cate[$i]->room_type; ?></option>
					<?php	
                    }
					}
                    ?>
    ...
    else
    {
            ...
            <tr height="35">
                ...
                <td><select name="occupancy" id="occupancy" style="width:150px;">
                   ...
                   // for($j=1;$j<=20;$j++){
                    ?>
                      <option value="<?php echo $results[0][0]->occupancy; ?>"> <?php echo $results[0][0]->occupancy; ?></option>
					<?php	
                   // }
                    ?>
            ...
            <tr height="35">
                <td>Adult: </td>
                <td>
                <input type="text" id="no_of_adults" name="no_of_adults" value="<?php echo $results[0][0]->adult; ?>" />
           ...
           <span style="color:#FF0000;"> <?php echo form_error('adult');?></span>
            ...
            <tr height="35">
                <td>Child: </td>
                <td>
                <input type="text" id="no_of_childs" name="no_of_childs" value="<?php echo $results[0][0]->child; ?>" />
            ...
            <tr height="35">
               ...
               <td><span style="margin-left:150px;">&nbsp;</span> Above <input type="text" id="child_above_age" name="child_above_age" value="<?php if(isset($room_pre_details->child_above_age) && $room_pre_details->child_above_age!='')echo $room_pre_details->child_above_age; ?>" size="5"/> age&nbsp;&nbsp;&nbsp;&nbsp; charge
                <input type="text" id="child_above_age_charge" name="child_above_age_charge" value="<?php echo $results[0][0]->child_above_age_charge; ?>" size="5"/>&nbsp;</td>
            </tr>
            
            <tr height="35">
                <td>Child Extra Bed Charge: </td>
                <td><input type="text" id="child_extra_bed_charge" name="child_extra_bed_charge" value="<?php echo $results[0][0]->child_extra_bed_charge; ?>" /></td>
            </tr>
            
            <tr height="35">
                <td>Infant: </td>
                <td><input type="text" id="no_of_infants" name="no_of_infants" value="<?php echo $results[0][0]->infant; ?>" /></td>
            </tr>
           ...
           <tr>
            ...
            <tr>
              ...
              <br />   
           Breakfast Type: <input type="text" name="breakfast_type" value="<?php echo $results[0][0]->breakfast_type; ?>" />
           <br />
           Adult Meal Rates:- Breakfast:<input type="text" name="adult_meal_plan_breakfast_rate" size="5" value="<?php echo $results[0][0]->adult_meal_plan_breakfast_rate; ?>"/>amt,
           &nbsp; Lunch:<input type="text" name="adult_meal_plan_lunch_rate" size="5" value="<?php echo $results[0][0]->adult_meal_plan_lunch_rate; ?>"/>amt,
           &nbsp; Dinner:<input type="text" name="adult_meal_plan_dinner_rate"  size="5" value="<?php echo $results[0][0]->adult_meal_plan_dinner_rate; ?>"/>amt    
             <br /> 
             
             Child Meal Rates:-  Breakfast:<input type="text" name="child_meal_plan_breakfast_rate" size="5"  value="<?php echo $results[0][0]->child_meal_plan_breakfast_rate; ?>"/>amt,
           &nbsp; Lunch:<input type="text" name="child_meal_plan_lunch_rate" size="5" value="<?php echo $results[0][0]->child_meal_plan_lunch_rate; ?>"/>amt,
           &nbsp; Dinner:<input type="text" name="child_meal_plan_dinner_rate"  size="5" value="<?php echo $results[0][0]->child_meal_plan_dinner_rate; ?>"/>amt    
                </td>
            </tr>
...
Supplement Rate:<input type="text" name="supplement_rate" size="5" value="<?php echo $results[0][0]->supplement_rate; ?>"/>amt
				</td>
            </tr>
           ...
           &nbsp; Dinner:<input type="text" name="child_meal_plan_dinner_rate"  size="5" value="<?php if(isset($rat_tac_details->child_meal_plan_dinner_rate) && $rat_tac_details->child_meal_plan_dinner_rate != '0') echo $rat_tac_details->child_meal_plan_dinner_rate; ?>"/>amt   </br> 
            ...
            <tr height="35">
                ...
                <td><textarea name="remarks" id="remarks" cols="50" rows="4"><?php echo $results[0][0]->remarks; ?></textarea></td>
            </tr>
            <tr><td>&nbsp;</td><td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="font-size:13px;">
                    DayPrior: <input type="text" name="cancel_policy_nights[]" id="cancel_policy_nights[]" size="3" value="<?php echo $results[0][0]->cancel_policy_nights;?>"/>
<!--                <select name="cancel_policy_nights[]" id="cancel_policy_nights[]" style="width:60px;">
                	...
                	Charge<input type="text" id="cancel_policy_percent[]" name="cancel_policy_percent[]" size="4" value="<?php echo $results[0][0]->cancel_policy_percent;?>"/>%&nbsp;
                    or<input type="text" id="cancel_policy_charge[]" name="cancel_policy_charge[]" size="4" value="<?php echo $results[0][0]->cancel_policy_charge;?>"/>Night Charge&nbsp;
                    From<input type="text" id="cancel_from" name="cancel_policy_from[]" size="7" value="<?php echo $results[0][0]->cancel_policy_from;?>"/>&nbsp;
                    <input type="hidden" id="c_from" />&nbsp;
                    To<input type="text" id="cancel_to" name="cancel_policy_to[]" size="7" value="<?php echo $results[0][0]->cancel_policy_to;?>"/>
                ...
                <tr>
                <td>&nbsp;</td>
                <td><textarea name="cancel_policy_desc" id="cancel_policy_desc" cols="50" rows="4"><?php echo $results[0][0]->cancel_policy_desc ?></textarea></td>
                </tr>
            ...
            <tr>
                ...
                <td style="font-size:13px;">
                    ...
                    From<input type="text" id="minimum_stay_from[]" name="minimum_stay_from[]" size="7" value="<?php echo $res[0]->minimum_stay_from;?>"/>&nbsp;
                    To<input type="text" id="minimum_stay_to[]" name="minimum_stay_to[]" size="7" value="<?php echo $res[0]->minimum_stay_to;?>"/>
                    
                     Nights: <input type="text" name="minimum_stay_nights[]" id="minimum_stay_nights[]" style="width:50px" value="<?php echo $res[0]->minimum_stay_nights;?>"/>
    ...
    <td style="width:220px;"> Room Available Dates:
        ...
        <?php
            ...
            $next_dte = date("d-m-Y",strtotime("+8 days"));
        ?>
    <td style="width:100px;"><input name="sd[]" id="datepickeram" type="text" class="b2b-txtbox"  style=" background-image: url('<?php echo WEB_DIR; ?>images/b2b-calicon.png');background-repeat:no-repeat;background-position:right center;width:100px; height:18px;"/><input type="hidden" id="hid_sd" /></td>
    <td >&nbsp;</td>
    <td  style="width:100px;"><span id="out"><input name="ed[]" id="datepickerbm" type="text" class="b2b-txtbox" style=" background-image: url('<?php echo WEB_DIR; ?>images/b2b-calicon.png'); background-repeat:no-repeat;background-position:right center;width:100px; height:18px;"/><input type="hidden" id="hid_ed" /></span></td>
    ...
    <td style="border-right:solid 1px #deab6f; text-align:center; padding-left:0px;"><input name="price" id="price" type="text" class="input-field"  style="height:20px; margin-top:3px; background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->rate;?>"/></td>
    <td style="border-right:solid 1px #deab6f; text-align:center; padding-left:0px;"><input name="extra_bed_price" id="extra_bed_price" type="text" class="input-field"  style="height:20px; margin-top:3px; background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->extra_bed_price;?>"/></td>
    <td style="border-right:solid 1px #deab6f; text-align:center; padding-left:0px;"><input name="avail" id="avail" type="text" class="input-field"  style="height:20px; margin-top:3px; background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->available_rooms;?>"/></td>
    <td style="border-right:solid 1px #deab6f; text-align:center; padding-left:0px;">                      <!--<select name="adult" id="adult" style="width:60px;">
                        ...
                        <input name="adult" id="adult" type="text" class="input-field"  style="height:20px; margin-top:3px; background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->adult;?>"/>
                        </td>
    <td style="border-right:solid 1px #deab6f; text-align:center; padding-left:0px;">                       <!--<select name="child" id="child" style="width:60px;">
                        ...
                        <input name="child" id="child" type="text" class="input-field"  style="height:20px; margin-top:3px; background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->child;?>"/>
                        </td>
     <td style="border-right:solid 1px #deab6f; text-align:center; padding-left:0px;"><input name="child_price" id="child_price" type="text" class="input-field"  style="height:20px; margin-top:3px; background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->child_charge;?>"/></td>
    <td style="border-right:solid 1px #deab6f; text-align:center; padding-left:0px;"><input name="infant" id="infant" type="text" class="input-field"  style="height:20px; margin-top:3px; background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->infant;?>"/></td>
    <td style="border-right:solid 1px #deab6f; text-align:center; padding-left:0px;"><input name="sup_charge" id="sup_charge" type="text" class="input-field"  style="height:20px; margin-top:3px; background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->supplementary_charge_rate;?>"/></td>
...
<tr>
    <td align="center"><input type="image" src="<?php echo WEB_DIR ?>images/save-but.png" onclick="get_more_data()" /></td>
