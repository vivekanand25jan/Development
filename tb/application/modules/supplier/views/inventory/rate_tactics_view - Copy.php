...
<table width="942" border="0" align="left" cellpadding="0" cellspacing="0" style="margin:15px 0 0 17px; ">
  <tr>
    <td align="right" valign="top" class="" colspan="9" height="30"><a href="<?php echo site_url('index/add_rate_plan_view/')?>/<?php echo $this->uri->segment(3); ?>/1" style="color:#099; font-weight:bold;">Add room rate</a></td>
  </tr>
   <tr>
  ...
  <tr>
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/view_rate_tactics_details/<?php echo $this->uri->segment(3); ?>/<?php echo $result[$i]->sup_rate_tactics_id; ?>" style="text-decoration:none;color:#099; text-transform:capitalize; float:left;">
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php $fd = $result[$i]->room_avail_date_from; $fds = explode("-",$fd); $from_date = $fds[2].'-'.$fds[1].'-'.$fds[0]; $td = $result[$i]->room_avail_date_to; $tds = explode("-",$td); $to_date = $tds[2].'-'.$tds[1].'-'.$tds[0]; echo $from_date.' To '.$to_date;	
     ...
     <a href="<?php echo site_url('index/add_rate_plan_view/')?>/<?php echo $this->uri->segment(3); ?>/<?php echo $result[$i]->season_id; ?>" title="Add Season Period">
