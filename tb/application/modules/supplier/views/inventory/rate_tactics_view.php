...
<?php if($i==0 && $j==0) { ?>
   ...
   <td align="left" valign="center" class="my_profile_name_ex_tab_whit" rowspan="<?php echo count($result);?>">
    ...
    <?php /*?><td align="left" valign="center" class="my_profile_name_ex_tab_whit" rowspan="<?php echo count($result);?>">
...
<?php } ?>
	...
	echo '<b>'.$from_date.'</b> To <b>'.$to_date.'</b>';	
     ...
     <?php /*?><td align="left" valign="center" class="my_profile_name_ex_tab_whit">
     
     <a href="<?php echo site_url('index/add_allocations/')?>/<?php echo $this->uri->segment(3); ?>/<?php echo $result[$i]->season_id; ?>/<?php echo $result[$i]->category_type; ?>/<?php echo $result[$i]->sup_rate_tactics_id; ?>" title="Add Allocations">
