...
$(document).ready(function(){
	...
	$.post( "<?php print WEB_URL ?>index/getAvailDatesForPromotion", {mmsd:sd, mmed:ed, promo_id:<?php echo $this->uri->segment(5); ?>, selectedDays:selectedDays},
      function(data) {
		  //alert(data);
		if(data != ''){
			$("#filtering").show();
...
<div id="result1">
     ...
     <form name="form1" action="<?php echo WEB_URL; ?>index/edit_promotion_plan/<?php echo $prop_id; ?>/<?php echo $id; ?>/<?php echo $promo_id; ?>" method="post">
  ...
  <table width="600" border="0" align="left" cellpadding="5" cellspacing="5" style="margin:15px 0 0 17px;">
...
function getDates(){
	...
	$.post( "<?php print WEB_URL ?>index/getAvailDatesForPromotion", {mmsd:sd, mmed:ed, promo_id:<?php echo $this->uri->segment(5); ?>, selectedDays:selectedDays, da:'days'},
      function(data) {
		if(data != ''){
			$("#filtering").show();
			$("#monthDates").html('');
			for(var i=0; i<data.dates.length; i++){
				...
				$("#monthDates").append('<tr style="border-top:solid 1px #deab6f; border-bottom:solid 1px #deab6f; padding-bottom:2px;"><td style="border-right:solid 1px #deab6f; text-align:left; width:10%;font-size:11.5px;padding-left:0px;" id="tdtd">'+data.dates[i]+'<input type="hidden" name="datess[]" value="'+day[0]+'"><input type="hidden" name="weekday[]" value="'+day[1]+'"></td><td style="border-right:solid 1px #deab6f; text-align:center; width:10%;padding-left:0px;" id="tdtd3"><input name="price[]" type="text" class="input-field" style="height:20px; background:#F2F2F2;" size="5"/></td><td style="border-right:solid 1px #deab6f; text-align:center; width:10%;padding-left:0px;" id="tdtd3"><input name="extra_bed_price[]" type="text" class="input-field" style="height:20px;  background:#F2F2F2;" size="5"/></td><td style="border-right:solid 1px #deab6f;padding-left:0px; text-align:center; width:10%;" id="tdtd3"><input name="avail[]" type="text" class="input-field" style="height:20px; background:#F2F2F2;" size="5"/></td><td style="border-right:solid 1px #deab6f;padding-left:0px; text-align:center; width:10%;" id="tdtd3"><input name="adult[]" id="adult[]" type="text" class="input-field"  style="height:20px;  background:#F2F2F2;" size="5"/></td><td style="border-right:solid 1px #deab6f; padding-left:0px;text-align:center; width:10%;" id="tdtd3"><input name="child[]" id="child[]" type="text" class="input-field"  style="height:20px;  background:#F2F2F2;" size="5"/></td><td></td><td style="border-right:solid 1px #deab6f; text-align:center; width:10%;padding-left:0px;" id="tdtd3"><input name="child_price[]" type="text" class="input-field" style="height:20px; background:#F2F2F2;" size="5"/></td><td style="padding-left:0px;border-right:solid 1px #deab6f; text-align:center; width:10%;" id="tdtd3"><input name="infant[]" type="text" class="input-field" style="height:20px; background:#F2F2F2;" size="5"/></td><td style="padding-left:0px;border-right:solid 1px #deab6f; text-align:center; width:11%;" id="tdtd3"><input name="sup_charge[]" type="text" class="input-field" style="height:20px;  background:#F2F2F2;" size="5"/></td><td style="border-right:solid 1px #deab6f; text-align:center; width:9%;" id="tdtd3">&nbsp;</td></tr>');
			}
		} 
	  }
	);
