...
<div>
    ...
    <div class="hotelnames" style="min-height:329px; width:716px;">
        ...
        <table width="100%" border="0" cellspacing="7" cellpadding="3" class="r-hoteldeta">
          <tr>
          	<td colspan="2" class="right-hotel-name" style="font-size:26px; color:#336699; padding-top:0px; padding-bottom:15px">Booking Calendar</td>
          </tr>
          <tr>
    ...
    <table>
    <tr>
          	<td style="font-size:26px; color:#336699; padding-top:0px; padding-bottom:0px" class="right-hotel-name" colspan="2">Hotel List</td>
          </tr></table>
  ...
  <tr>
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php echo $result[$i]->city_name; ?> 	</td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php echo $result[$i]->property_name; ?> </td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit">hh </td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL;?>index/edit_contact_inform/<?php echo $result[$i]->sup_id ?>/<?php echo $result[$i]->sup_contact_inform_id ?>">View</a> </td>
