...
$(document).ready(function () {
	...
	$("#__reset_filter").click(function() {
			...
			$.ajax({
				  ...
				  success: function(data){
					...
					//alert(data.min_val);
					//$( "#amount" ).val( "USD " + $( "#slider-range" ).slider( "values", 10 ) +
					//" - USD " + $( "#slider-range" ).slider( "values", 300 ) );
					
					//$('#slider-range').slider( "option", "min", data.min_val );
					//$('#slider-range').slider( "option", "max", data.max_val );
					
					$("#slider").slider('option',{min: data.min_val, max: data.max_val});
					...
					//$( "#amount_dummy" ).val( "<?php echo $this->session->userdata('currency');?> " + data.min_val + "  to  <?php echo $this->session->userdata('currency');?> " + data.max_val );
					//$( "#amount" ).val( "USD " + r + "  to  USD " + rr );
					
					$( "#amount_dummy" ).val( "USD " + r + "  to  USD " + rr );
					
					/*$('#slider-range-star').slider( "option", "min", 0 );
					$('#slider-range-star').slider( "option", "max", 5 );
					$( "#star" ).val( "0 - 5");*/
   ...
   function hotel_fac_sorting(sorting) {
			var minVal = $( "#slider-range" ).slider( "values", 0 );
			var maxVal = $( "#slider-range" ).slider( "values", 1 );
			//alert(minVal + "," + maxVal);
			var minStar = $( "#slider-range-star" ).slider( "values", 0 );
	...
	//	$("#result_count").html(11);
		...
		function price_rating_asc() {
			...
			var params = 'minVal='+minVal+'&maxVal='+maxVal+'&minStar='+minStar+'&maxStar='+maxStar+'&facilities='+facilities+'&facilities='+facilities;
		...
		function __price_rating_asc() //chitta
{
		$.ajax({
                    ...
                    <form  name="leftfilter"  id="hotels-results-form">
                    		<div class="left_pannel">
                                    ...
                                    <div class="left_pannel_body">
                                    		<div class="wi159"><a id="reset_filter">Reset Filters </a></div>
                                      ...
                                      <!--<div class="wi159">
                                       ...
                                       <div class="hotel_cover">
                                         ...
                                         <div class="hotel_cover">
                                          ...
                                          <div class="hotel_cover">
                                         	<div class="check_box_cover"><input type="checkbox" name="hotel_fac_val" onclick="javascript:hotel_fac_sorting()"  value="gym" id="5" /></div>
...
Map
	...
	<li>
		<a href="javascript:void(0);">Price</a>
			...
			<li><a href="javascript:void(0);"  onclick="javascript:return  hotel_fac_sorting('price_asc')">Low To high</a></li>

			<li><a href="javascript:void(0);"   onclick="javascript:return  hotel_fac_sorting('price_desc')">High To Low</a></li>
	...
	<li>
		...
		<ul>
			...
			<li><a href="javascript:void(0);"  onclick="javascript:return  hotel_fac_sorting('star_asc')" >1star to 5star</a></li>

			<li><a href="javascript:void(0);"  onclick="javascript:return  hotel_fac_sorting('star_desc')">5star to 1star</a></li>
	...
	<li>
		...
		<ul>
			...
			<li><a href="javascript:void(0);"  onclick="javascript:return  hotel_fac_sorting('name_asc')">A to Z</a></li>
			<li><a href="javascript:void(0);"  onclick="javascript:return  hotel_fac_sorting('name_desc')">Z to A</a></li>
