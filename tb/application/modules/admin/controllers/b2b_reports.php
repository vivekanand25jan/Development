...
<div style="float:left; width:200%; padding-bottom:85px; position:absolute; margin-top:10px;">
  ...
  { 
	...
	$ext_pri = 0;
	for($nth = 0;$nth<count($extra);$nth++){ $ext_pri+=$extra[1];} echo $ext_pri.'kk';
   	  ?>
      <tr id="result">
	...
	<td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $net_amount = ($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?$result_view[$i]->cancelled_charge*$result_view[$i]->currency_val-$net_after_cancel:($result_view[$i]->net_amount*$result_view[$i]->currency_val)+$ext_pri;?></td>
 	  ...
 	  for($i=0;$i<count($result_view);$i++)
	  {
	   ...
	   $con_i=$this->admin_model->contact_info_detail_update_new($con_id);
		$extra = explode("--",$result_view[$i]->extra_services);
	$ext_pri = 0;
	for($nth = 0;$nth<count($extra);$nth++){ $ext_pri+=$extra[1];} echo $ext_pri.'jj';
   	  ?>
      <tr id="result">
	...
	<td class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td  style="background-color:#D3FEFA" class="admin-table-colo-tab"><?php echo $aa =($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?$result_view[$i]->cancelled_charge*$result_view[$i]->currency_val:($result_view[$i]->amount);?></td>
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->xml_currency;?></td>
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $net_amount = ($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?$result_view[$i]->cancelled_charge*$result_view[$i]->currency_val:($result_view[$i]->net_amount*$result_view[$i]->currency_val)+$ext_pri;?></td>
                  <td  style="background-color:#D3FEFA" class="admin-table-colo-tab"><?php echo $net_profit = ($aa-$net_amount); ?></td>
  ...
  if($result_view!='')
  {
	   ...
	   for($i=0;$i<count($result_view);$i++)
	  {
	   ...
	   $con_i=$this->admin_model->contact_info_detail_update_new($con_id);
		$extra = explode("--",$result_view[$i]->extra_services);
	$ext_pri = 0;
	for($nth = 0;$nth<count($extra);$nth++){ $ext_pri+=$extra[1];} echo $ext_pri.'gg';
   	  ?>
      <tr id="result">
           <td   style="background-color:#D3FEFA;background-image:url(<?php echo WEB_DIR; ?>images/g-r.png); background-repeat:no-repeat;" class="admin-table-colo-tab"><a href="<?php echo WEB_URL; ?>index/view_book_detail/<?php echo $result_view[$i]->transaction_details_id; ?>"><?php //echo $result_view[$i]->prn_no;?> <?php echo $result_view[$i]->booking_number; ?></a></td>
	<td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
 	  ...
 	  for($i=0;$i<count($result_view);$i++)
	  {
	   ...
	   $con_i=$this->admin_model->contact_info_detail_update_new($con_id);
		$extra = explode("--",$result_view[$i]->extra_services);
	$ext_pri = 0;
	for($nth = 0;$nth<count($extra);$nth++){ $ext_pri+=$extra[1];} echo $ext_pri.'tt';
   	  ?>
      <tr id="result">
