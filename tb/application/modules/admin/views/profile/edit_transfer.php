...
<div style="margin-top:20px;">
    ...
    <form name="form1" action="<?php echo WEB_URL; ?>index/edit_transfer/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>" method="post">
    ...
    <table width="780" border="0" cellspacing="1" cellpadding="0"><caption><h4 align="left">Transfer Information</h4></caption>
    		<tr height="35">
               ...
               <?php  $sup = $this->Supplier_Model->get_supplier_name(); 
			   		...
			   		$supplier_id= $this->Supplier_Model->get_tr_sup_select_type($result->sup_transfer_id); 
			   ?>
        	...
        	<tr height="35">
            	<td>From :</td>
                <td><input type="text" name="pick_up" size="30" value="<?php if(isset($result->pick_up)) echo $result->pick_up; ?>"  required/></td></br>
                <span style="color:#FF0000;"> <?php echo form_error('pick_up');?></span>	
            </tr>
            <tr height="35">
            	<td>To :</td>
                <td><input type="text" name="drop_off" size="30" value="<?php if(isset($result->drop_off)) echo $result->drop_off; ?>" required /></td>
                </br>
            ...
            <tr height="35">
                ...
                <td><input type="text" name="car_price" size="20" value="<?php  if(isset($result->car_price)) echo $result->car_price; ?>" /> AED</td>
            </tr>
               <tr height="35">
            	<td>Individual TRF Price for Mini Van (1-3 pax) :</td>
                <td><input type="text" name="minivan_price" size="20" value="<?php if(isset($result->minivan_price)) echo $result->minivan_price; ?>" /> AED</td>
            </tr>
     	
             <tr height="35">
            	<td>Individual TRF Price for Micro Bus 1(4-8 pax) :</td>
                <td><input type="text" name="microbus1_price" size="20" value="<?php if(isset($result->microbus1_price)) echo $result->microbus1_price; ?>" /> AED</td>
            </tr>
             <tr height="35">
            	<td>Individual TRF Price for Micro Bus 2(9-20 pax) :</td>
                <td><input type="text" name="microbus2_price" size="20" value="<?php  if(isset($result->microbus2_price)) echo $result->microbus2_price; ?>" /> AED</td>
            </tr>
           <tr height="35">
            	<td>Individual TRF Price for Bus(21 & above pax) :</td>
                <td><input type="text" name="bus_price" size="20" value="<?php if(isset($result->bus_price)) echo $result->bus_price; ?>" /> AED</td>
             </tr>
             <tr  height="35">
                <td>Notes:</td>
