...
<div id="containerdount">
 <div style="float:right; height:15px;"><a href="<?php echo site_url('index/excursion')?>" style="color:#099;">Back</a></div>
 <div style="clear:both"></div>
 <div style="float:right; height:15px;"><a href="<?php echo site_url('index/add_excursion')?>/<?php echo $this->uri->segment(3); ?>" style="color:#099; font-weight:bold;">Add Excursion</a></div>
...
<?php $fromD = explode('-',$car_period->from_date);
      ...
      echo '<b>Excursion Period : </b> '.$fromD.' To '.$toD; ?>  
   ...
   <tr>
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab">Excursion Name</td>
    <td align="left" valign="top" class="my_profile_name_ex_tab">Pax</td>
    <td align="left" valign="top" class="my_profile_name_ex_tab">Duration</td>
  ...
  <tr>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php echo $i+1; ?></td>
     <?php  $supp_id = $this->Supplier_Model->get_ex_sup_select_type($result[$i]->sup_excursion_id); 
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/edit_excursion_details/<?php echo $this->uri->segment(3); ?>/<?php echo $result[$i]->sup_excursion_id ; ?>" style="text-decoration:none;color:#099;"><?php 
	
	echo '<b>'.$result[$i]->excursion_name.'</b>' ?></a></td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php echo '<b>'.$result[$i]->no_of_passengers.'</b>' ?></td>
     <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php echo '<b>'.$result[$i]->duration.'</b>' ?></td>
   
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php if($result[$i]->status==1) { echo 'Active'; } else { echo 'InActive'; } ?></td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/update_excursion_details/<?php echo $this->uri->segment(3); ?>/<?php echo $result[$i]->sup_excursion_id  ; ?>/1" style="color:#000;">Active</a> / 
    <a href="<?php echo WEB_URL; ?>index/update_excursion_details/<?php echo $this->uri->segment(3); ?>/<?php echo $result[$i]->sup_excursion_id  ; ?>/0" style="color:#000;">InActive</a> / 
    <a href="<?php echo WEB_URL; ?>index/update_excursion_details/<?php echo $this->uri->segment(3); ?>/<?php echo $result[$i]->sup_excursion_id  ; ?>/2" style="color:#000;">Delete</a></td>
  </tr>
  <?php
	}
}
