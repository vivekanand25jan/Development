...
<div id="containerdount">
 <div style="float:right; height:15px;"><a href="<?php echo site_url('index/car_rental')?>" style="color:#099;">Back</a></div>
 <div style="clear:both"></div>
 <div style="float:right; height:9px;"><a href="<?php echo site_url('index/add_car_rental')?>/<?php echo $this->uri->segment(3); ?>" style="color:#099; font-weight:bold;">Add Car Rental</a></div>
   
<div style="margin-top:2px;">
<?php $fromD = explode('-',$car_period->from_date);
      $fromD = $fromD[2].'-'.$fromD[1].'-'.$fromD[0];
      
      $toD = explode('-',$car_period->to_date);
      $toD = $toD[2].'-'.$toD[1].'-'.$toD[0];

      echo '<b>Car Rental Period : </b> '.$fromD.' To '.$toD; ?>  
   ...
   <tr>
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab" width="20%">Supplier Name</td>
    <td align="left" valign="top" class="my_profile_name_ex_tab">Model or Car Type</td>
    <td align="left" valign="top" class="my_profile_name_ex_tab">Passengers</td>
    <td align="left" valign="top" class="my_profile_name_ex_tab">Doors</td>
  ...
  <tr>
    ...
    <?php  $supp_id = $this->Supplier_Model->get_sup_select_type($result[$i]->sup_car_rental_id); 
			//print '<pre />';print_r($supp_id);exit;
	?>
     <td align="left" valign="top" class="my_profile_name_ex_tab_whit" width="20%"><?php  for($j=0;$j<count($supp_id); $j++) echo $this->Supplier_Model->get_sup_name_select_type($supp_id[$j]->sup_id); ?></td>
     <?php $cat_type=$this->Supplier_Model->get_cat_select_type($result[$i]->car_type);?>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit" ><a href="<?php echo WEB_URL; ?>index/edit_car_rental_details/<?php echo $this->uri->segment(3); ?>/<?php echo $result[$i]->sup_car_rental_id; ?>" style="text-decoration:none;color:#099;"><?php 
	
	echo '<b>'.$cat_type->car_type.'</b>' ?></a></td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php echo '<b>'.$result[$i]->no_of_passengers.'</b>' ?></td>
     <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php echo '<b>'.$result[$i]->no_of_doors.'</b>' ?></td>
   
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php if($result[$i]->status==1) { echo 'Active'; } else { echo 'InActive'; } ?></td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/update_car_rental_details/<?php echo $this->uri->segment(3); ?>/<?php echo $result[$i]->sup_car_rental_id  ; ?>/1" style="color:#000;">Active</a> / 
    <a href="<?php echo WEB_URL; ?>index/update_car_rental_details/<?php echo $this->uri->segment(3); ?>/<?php echo $result[$i]->sup_car_rental_id  ; ?>/0" style="color:#000;">InActive</a> / 
    <a href="<?php echo WEB_URL; ?>index/update_car_rental_details/<?php echo $this->uri->segment(3); ?>/<?php echo $result[$i]->sup_car_rental_id  ; ?>/2" style="color:#000;">Delete</a></td>
  </tr>
  <?php
	}
}
