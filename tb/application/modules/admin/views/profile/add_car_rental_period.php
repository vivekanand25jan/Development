...
<div style="margin-top:20px;">
     <div style="float:right; height:25px; margin-top:10px ; margin-right:-150px;"><a href="<?php echo site_url('index/car_rental')?>" style="color:#099;">Back</a></div>
   
    <div style="float:left; margin-left:20px;">
    <form name="form1" action="<?php echo WEB_URL; ?>index/add_car_period" method="post">
   ...
   <tr height="35">
    ...
    <td><input value="" name="from_date" id="datepicker"  onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox"  style=" background-image: url('<?php echo WEB_DIR_FRONT; ?>images/b2b-calicon.png');   background-repeat: no-repeat;  background-position: right center;" /> 
  ...
  <tr height="35">
    ...
    <td><input  value="" name="to_date" id="datepicker1" onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox" style=" background-image: url('<?php echo WEB_DIR_FRONT; ?>images/b2b-calicon.png');   background-repeat: no-repeat;  background-position: right center;" />&nbsp;&nbsp;
