...
<div style="margin-top:5px;">
  ...
  <tr>
    <td align="right" valign="top" class="" colspan="5" height="30"><a href="<?php echo site_url('index/excursion_period')?>" style="color:#099; font-weight:bold;">Add Period</a></td>
  </tr>
   <tr>
    <td align="left" valign="top" class="my_profile_name_ex_tab">No</td>
    <td align="left" valign="top" class="my_profile_name_ex_tab">Excursion Period</td>
    <td align="left" valign="top" class="my_profile_name_ex_tab">Excursion</td>
  ...
  <tr>
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/edit_excursion_period/<?php echo $result[$i]->excursion_period_id ; ?>" style="text-decoration:none;color:#099;"><?php 
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/view_excursion_details/<?php echo $result[$i]->excursion_period_id ; ?>" style="text-decoration:none;color:#099; font-weight:bold;">Add Excursion</a></td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php if($result[$i]->status==1) { echo 'Active'; } else { echo 'InActive'; } ?></td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/update_excursion_period/<?php echo $result[$i]->excursion_period_id   ; ?>/1" style="color:#000;">Active</a> / <a href="<?php echo WEB_URL; ?>index/update_excursion_period/<?php echo $result[$i]->excursion_period_id;?>/0" style="color:#000;">InActive</a> / <a href="<?php echo WEB_URL; ?>index/update_excursion_period/<?php echo $result[$i]->excursion_period_id; ?>/2" style="color:#000;">Delete</a></td>
  </tr>
  <?php
	}
}
