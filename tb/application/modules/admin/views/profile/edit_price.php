...
<ul class="tabs1">
 ...
 <li><a href="<?php echo WEB_URL;?>index/transfer/<?php echo $this->uri->segment(3)?>" >Transfer</a></li>
 <li><a href="<?php echo WEB_URL;?>index/transfer/<?php echo $this->uri->segment(3)?>" id="tabs_active">Prices</a></li>
...
<div id="containerdount">
 <div style="float:right; height:25px; margin-top:10px ;"><a href="<?php echo site_url('index/prices_list')?>" style="color:#099;">Back</a></div>
  
<div style="margin-top:20px;">
    
    <div style="float:left; margin-left:20px;">
    <form name="form1" action="<?php echo WEB_URL; ?>index/edit_price_details/<?php echo $this->uri->segment(3); ?>" method="post">
            ...
            <?php  $sup = $this->Supplier_Model->get_supplier_name();
					...
					$supplier_id= $this->Supplier_Model->get_pr_sup_select_type($result->sup_prices_id); 
			 ?>
    		...
    		<table width="800" border="0" cellspacing="1" cellpadding="0"><caption><h4 align="left">Add Prices List</h4></caption>
    		<tr height="25">
            	<td width="12%">From</td>
                <td ><input type="text" name="from_city" size="20"  required  value="<?php if(isset($result->from_city)) { echo $result->from_city; }?>"/></td>
                <td width="10%">To</td>
                <td><input type="text" name="to_city" size="20" required value="<?php if(isset($result->to_city)) { echo $result->to_city; }?>" /></td>
            </tr>
            </table>
           ...
           <table width="800" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr height="25">
            	<td>Car </td>
                <td><input type="text" name="car_5hrs_prc" size="15" value="<?php if(isset($result->car_5hrs_prc)) { echo $result->car_5hrs_prc; }?>" /></td>
                <td><input type="text" name="car_10hrs_prc" size="15"  value="<?php if(isset($result->car_10hrs_prc)) { echo $result->car_10hrs_prc; }?>"/></td>
                <td><input type="text" name="car_extra_hrs_prc" size="15" value="<?php if(isset($result->car_extra_hrs_prc)) { echo $result->car_extra_hrs_prc; }?>" /></td>
            </tr>
          
           <tr height="25">
            	<td>Mini van </td>
                <td><input type="text" name="mini_van_5hrs_prc" size="15" value="<?php if(isset($result->mini_van_5hrs_prc)) { echo $result->mini_van_5hrs_prc; }?>" /></td>
                <td><input type="text" name="mini_van_10hrs_prc" size="15" value="<?php if(isset($result->mini_van_10hrs_prc)) { echo $result->mini_van_10hrs_prc; }?>" /></td>
                <td><input type="text" name="mini_van_extra_hrs_prc" size="15" value="<?php if(isset($result->mini_van_extra_hrs_prc)) { echo $result->mini_van_extra_hrs_prc; }?>" /></td>
            </tr>
           
            <tr height="25">
            	<td>15 Seater</td>
                <td><input type="text" name="seat15_5hrs_prc" size="15" value="<?php if(isset($result->seat15_5hrs_prc)) { echo $result->seat15_5hrs_prc; }?>" /></td>
                <td><input type="text" name="seat15_10hrs_prc" size="15"  value="<?php if(isset($result->seat15_10hrs_prc)) { echo $result->seat15_10hrs_prc; }?>" /></td>
                <td><input type="text" name="seat15_extra_hrs_prc" size="15" value="<?php if(isset($result->seat15_extra_hrs_prc)) { echo $result->seat15_extra_hrs_prc; }?>" /></td>
            </tr>
            <tr height="25">
            	<td>30 Seater</td>
                <td><input type="text" name="seat30_5hrs_prc" size="15" value="<?php if(isset($result->seat30_5hrs_prc)) { echo $result->seat30_5hrs_prc; }?>" /></td>
                <td><input type="text" name="seat30_10hrs_prc" size="15" value="<?php if(isset($result->seat30_10hrs_prc)) { echo $result->seat30_10hrs_prc; }?>" /></td>
                <td><input type="text" name="seat30_extra_hrs_prc" size="15" value="<?php if(isset($result->seat30_extra_hrs_prc)) { echo $result->seat30_extra_hrs_prc; }?>" /></td>
            </tr>
            <tr height="25">
            	<td>50 Seater</td>
                <td><input type="text" name="seat50_5hrs_prc" size="15" value="<?php if(isset($result->seat50_5hrs_prc)) { echo $result->seat50_5hrs_prc; }?>" /></td>
                <td><input type="text" name="seat50_10hrs_prc" size="15" value="<?php if(isset($result->seat50_10hrs_prc)) { echo $result->seat50_10hrs_prc; }?>" /></td>
                <td><input type="text" name="seat50_extra_hrs_prc" size="15" value="<?php if(isset($result->seat50_extra_hrs_prc)) { echo $result->seat50_extra_hrs_prc; }?>" /></td>
            </tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin:20px;">        
             <tr  height="35">
                ...
                <td ><textarea name="notes"  cols="50" rows="4"><?php if(isset($result->notes)) { echo $result->notes; }?></textarea></td>
            </tr> 
