...
<ul class="tabs1">
 ...
 <li><a href="<?php echo WEB_URL;?>index/excursion/<?php echo $this->uri->segment(3)?>" id="tabs_active">Excursion</a></li>
 </ul>
<?php
}
else
...
<div id="containerdount">
 <div style="float:right; height:25px; margin-top:10px ;"><a href="<?php echo site_url('index/view_excursion_details/')?>/<?php echo $this->uri->segment(3); ?>" style="color:#099;">Back</a></div>
  
<div style="margin-top:10px;">
    
    <div style="float:left; margin-left:8px;">
    <form name="form1" action="<?php echo WEB_URL; ?>index/edit_excursion/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>" method="post" enctype="multipart/form-data">
    
    
    <table width="780" border="0" cellspacing="1" cellpadding="0"><caption><h4 align="left">Excursion Information</h4></caption>
            <tr height="35">
           <td width="30%">Supplier Name</td>
           <?php  $sup = $this->Supplier_Model->get_supplier_name(); 
		   			//print '<pre />';print_r($sup);exit;
				$supplier_id= $this->Supplier_Model->get_ex_sup_select_type($result->sup_excursion_id); 
				//print '<pre />';print_r($supplier_id);exit;
           ...
           <td width="77%"> <select name="supplier_name[]" id="supplier_name" style="width:170px;" multiple="multiple" required  >
        	...
        	<tr height="35">
                ...
                <td><input type="text" name="excursion_name" size="30" value="<?php  if(isset($result->excursion_name)) echo $result->excursion_name; ?>" /></td>
            </tr>
            <tr height="35">
            	<td>Description:</td>
                <td><textarea name="description" id="description" cols="50" rows="4" ><?php if(isset($result->description)) echo $result->description; ?></textarea></td>
            </tr>
        
             
            <tr height="35">
                <td>Minimum Pax </td>
                <td><input type="text" name="no_of_passengers" size="20" value="<?php if(isset($result->no_of_passengers)) echo $result->no_of_passengers; ?>" />
                <span style="color:#FF0000;"> <?php echo form_error('adult');?></span></td>
            </tr>
            <tr height="35">
            
                <td valign="top">Pickup Time:</td>
                <td><input type="text" name="pickup_time" size="20" value="<?php  if(isset($result->pickup_time)) echo $result->pickup_time; ?>" /></td>
            </tr>
     	
            <tr height="35">
            
                <td valign="top">Duration:</td>
                <td><input type="text" name="duration" size="20"  value="<?php if(isset($result->duration)) echo $result->duration; ?>" /></td>
            </tr>
            <tr height="35">
            
                <td valign="top">Price for Adult:</td>
                <td><input type="text" name="adult_price" size="20" value="<?php if(isset($result->adult_price)) echo $result->adult_price; ?>"  />  AED</td>
            </tr>
             <tr height="35">
            
                <td valign="top">Price for Child:</td>
                <td><input type="text" name="child_price" size="30" value="<?php if(isset($result->child_price)) echo $result->child_price; ?>"  />  AED</td>
            </tr>
             
             <tr  height="35">
                <td valign="top">Image1:</td>
                	<input type="hidden" name="img1_url" value="<?php if(isset($result->image1_url)) echo $result->image1_url; ?>" />
                <td> <input name="image1_url"  type="file"  />
                </br><?php if(isset($result->image1_url)) { ?>
   				<div style="float:left; margin-top:5px; margin-bottom:10px;"> 
   				<img src="<?php echo WEB_DIR_FRONT ?>upload_images/<?php echo $result->image1_url; ?>" width="180" height="120" border="0" />
   				</div>
   				<?php } ?>
                </td>
            </tr> 
            ...
            <tr  height="35">
                ...
                <input type="hidden" name="img2_url" value="<?php if(isset($result->image2_url)) echo $result->image2_url; ?>" />
                <td> <input name="image2_url"  type="file" />
                 </br><?php if(isset($result->image2_url)) { ?>
   				<div style="float:left; margin-top:5px; margin-bottom:3px;"> 
   				<img src="<?php echo WEB_DIR_FRONT ?>upload_images/<?php echo $result->image2_url; ?>" width="180" height="120" border="0" />
   				</div>
   				<?php } ?>
                </td>
            </tr> 
