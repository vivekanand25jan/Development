...
<div id="containerdount">
    ...
    <div style="float:right; height:7px;"><a href="<?php echo site_url('index/dashboard/')?>" style="color:#099;">Go Back</a></div>
<div style="margin-top:5px;">
  ...
  <tr>
    ...
    <td align="right" valign="top" class="" colspan="5" height="30"><a href="<?php echo site_url('index/add_car_rental_period/')?>" style="color:#099; font-weight:bold;">Add Period</a></td>
  </tr>
   <tr>
  ...
  <tr>
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/view_car_rental_period/<?php echo $result[$i]->car_rental_period_id; ?>" style="text-decoration:none;color:#099; float:left;"><?php 
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/view_car_rental_details/<?php echo $result[$i]->car_rental_period_id; ?>" style="text-decoration:none;color:#099; ">Add Car Rental</a></td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php if($result[$i]->status==1) { echo 'Active'; } else { echo 'InActive'; } ?></td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/update_car_rental_period/<?php echo $result[$i]->car_rental_period_id ; ?>/1" style="color:#000;">Active</a> / <a href="<?php echo WEB_URL; ?>index/update_car_rental_period/<?php echo $result[$i]->car_rental_period_id ; ?>/0" style="color:#000;">InActive</a> / <a href="<?php echo WEB_URL; ?>index/update_car_rental_period/<?php echo $result[$i]->car_rental_period_id ; ?>/2" style="color:#000;">Delete</a></td>
  </tr>
  <?php
	}
}
