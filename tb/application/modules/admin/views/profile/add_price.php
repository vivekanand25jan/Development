...
<ul class="tabs1">
 ...
 <li><a href="<?php echo WEB_URL;?>index/transfer" >Transfer</a></li>
 <li><a href="<?php echo WEB_URL;?>index/transfer" id="tabs_active">Prices</a></li>
...
<div style="margin-top:20px;">
    ...
    <form name="form1" action="<?php echo WEB_URL; ?>index/add_prices_details" method="post">
    		...
    		<tr height="25">
            	<td width="12%">From</td>
                <td ><input type="text" name="from_city" size="20"  required/></td>
                <td width="10%">To</td>
                <td><input type="text" name="to_city" size="20" required /></td>
            </tr>
            </table>
           ...
           <table width="800" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr height="25">
            	<td>Car </td>
                <td><input type="text" name="car_5hrs_prc" size="15" /></td>
                <td><input type="text" name="car_10hrs_prc" size="15" /></td>
                <td><input type="text" name="car_extra_hrs_prc" size="15" /></td>
            </tr>
          
           <tr height="25">
            	<td>Mini van </td>
                <td><input type="text" name="mini_van_5hrs_prc" size="15" /></td>
                <td><input type="text" name="mini_van_10hrs_prc" size="15" /></td>
                <td><input type="text" name="mini_van_extra_hrs_prc" size="15" /></td>
            </tr>
           
            <tr height="25">
            	<td>15 Seater</td>
                <td><input type="text" name="seat15_5hrs_prc" size="15" /></td>
                <td><input type="text" name="seat15_10hrs_prc" size="15" /></td>
                <td><input type="text" name="seat15_extra_hrs_prc" size="15" /></td>
            </tr>
            <tr height="25">
            	<td>30 Seater</td>
                <td><input type="text" name="seat30_5hrs_prc" size="15" /></td>
                <td><input type="text" name="seat30_10hrs_prc" size="15" /></td>
                <td><input type="text" name="seat30_extra_hrs_prc" size="15" /></td>
            </tr>
            <tr height="25">
            	<td>50 Seater</td>
                <td><input type="text" name="seat50_5hrs_prc" size="15" /></td>
                <td><input type="text" name="seat50_10hrs_prc" size="15" /></td>
                <td><input type="text" name="seat50_extra_hrs_prc" size="15" /></td>
            </tr>
