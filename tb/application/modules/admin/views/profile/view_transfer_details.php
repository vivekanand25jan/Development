...
<div id="containerdount">
 <div style="float:right; height:15px;"><a href="<?php echo site_url('index/transfer')?>" style="color:#099;">Back</a></div>
 <div style="clear:both"></div>
 <div style="float:right; height:15px;"><a href="<?php echo site_url('index/add_transfer')?>/<?php echo $this->uri->segment(3); ?>" style="color:#099;">Add Transfer</a></div>
...
<?php $fromD = explode('-',$car_period->from_date);
      ...
      echo '<b>Transfer Period : </b> '.$fromD.' To '.$toD; ?>  
   ...
   <tr>
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab">From / To</td>
  ...
  <tr>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php echo $i+1; ?></td>
     <?php  $supp_id = $this->Supplier_Model->get_tr_sup_select_type($result[$i]->sup_transfer_id); 
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/edit_transfer_details/<?php echo $this->uri->segment(3); ?>/<?php echo $result[$i]->sup_transfer_id; ?>" style="text-decoration:none;color:#099; "><?php 
	
	echo '<b>'.$result[$i]->pick_up .'</b>';?>&nbsp;To&nbsp;<?php echo '<b>'.$result[$i]->drop_off .'</b>';?> </a></td>
    ...
    <a href="<?php echo WEB_URL; ?>index/update_transfer_details/<?php echo $this->uri->segment(3); ?>/<?php echo $result[$i]->sup_transfer_id; ?>/1" style="color:#000;">Active</a> / 
    <a href="<?php echo WEB_URL; ?>index/update_transfer_details/<?php echo $this->uri->segment(3); ?>/<?php echo $result[$i]->sup_transfer_id ; ?>/0" style="color:#000;">InActive</a> / 
    <a href="<?php echo WEB_URL; ?>index/update_transfer_details/<?php echo $this->uri->segment(3); ?>/<?php echo $result[$i]->sup_transfer_id ; ?>/2" style="color:#000;">Delete</a></td>
  </tr>
  <?php
	}
}
