...
<li><a href="<?php echo WEB_URL;?>index/prices_list" id="tabs_active" >Prices</a></li>
</ul>
...
<div style="margin-top:2px;">
  ...
  <tr>
    <td align="right" valign="top" class="" colspan="5" height="30"><a href="<?php echo site_url('index/add_price')?>" style="color:#099; font-weight:bold;">Add Price</a></td>
  </tr>
   <tr>
  ...
  <tr>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php echo $i+1; ?></td>
      <?php  $supp_id = $this->Supplier_Model->get_pr_sup_select_type($result[$i]->sup_prices_id); 
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/edit_price_list/<?php echo $result[$i]->sup_prices_id ; ?>" style="text-decoration:none;color:#099; "><?php 
		echo '<b>'.$result[$i]->from_city.'</b> To <b>'.$result[$i]->to_city.'</b>' ?></a></td>
    ...
    <a href="<?php echo WEB_URL; ?>index/update_price_list/<?php echo $result[$i]->sup_prices_id  ; ?>/1" style="color:#000;">Active</a> / 
    <a href="<?php echo WEB_URL; ?>index/update_price_list/<?php echo $result[$i]->sup_prices_id  ; ?>/0" style="color:#000;">InActive</a> / 
    <a href="<?php echo WEB_URL; ?>index/update_price_list/<?php echo $result[$i]->sup_prices_id; ?>/2" style="color:#000;">Delete</a></td>
  </tr>
  <?php
	}
}
