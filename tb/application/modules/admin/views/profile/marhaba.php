...
<div style="margin-top:2px;">
  ...
  <tr>
    <td align="right" valign="top" class="" colspan="5" height="30"><a href="<?php echo site_url('index/marhaba_service')?>" style="color:#099; font-weight:bold;">Add Meet and Greet Airport</a></td>
  </tr>
   <tr>
    <td align="left" valign="top" class="my_profile_name_ex_tab">No</td>
    <td align="left" valign="top" class="my_profile_name_ex_tab">Description</td>
    <td align="left" valign="top" class="my_profile_name_ex_tab">Description Category</td>
  ...
  <tr>
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/edit_marhaba_service/<?php echo $result[$i]->marhaba_services_id; ?>" style="text-decoration:none;color:#099;float:left; "><?php echo $result[$i]->description; ?></a></td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php echo $result[$i]->marhaba_desc_cate_name; ?></a></td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php if($result[$i]->status==1) { echo 'Active'; } else { echo 'InActive'; } ?></td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/update_marhaba_service_status/<?php echo $result[$i]->marhaba_services_id; ?>/1" style="color:#000;">Active</a> / <a href="<?php echo WEB_URL; ?>index/update_marhaba_service_status/<?php echo $result[$i]->marhaba_services_id; ?>/0" style="color:#000;">InActive</a> / <a href="<?php echo WEB_URL; ?>index/update_marhaba_service_status/<?php echo $result[$i]->marhaba_services_id; ?>/2" style="color:#000;">Delete</a></td>
  </tr>
  <?php
	}
}
