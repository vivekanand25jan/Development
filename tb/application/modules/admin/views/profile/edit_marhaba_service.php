...
<div style="margin-top:20px;">
    ...
    <form name="form1" action="<?php echo WEB_URL; ?>index/update_marhaba_services/<?php echo $this->uri->segment(3); ?>" method="post">
    ...
    <table width="780" border="0" cellspacing="1" cellpadding="0"><caption><h4 align="left">Meet and Greet Airport Services Corp Rates</h4></caption>
        ...
        <?php  $cate = $this->Supplier_Model->get_desc_cate(); ?>
            ...
            if(isset($cate[0]->marhaba_desc_cate_id))
                ...
                ?>
                  <option value="<?php echo $cate[$i]->marhaba_desc_cate_id; ?>" <?php if($cate[$i]->marhaba_desc_cate_id == $marhaba_service->desc_cate){ echo "selected='selected'"; } ?>><?php echo $cate[$i]->marhaba_desc_cate_name; ?></option>
                <?php	
                }
                }
                ?>      
        ...
        if(isset($car[0]->marhaba_air_code_id))
            ...
            ?>
              <option value="<?php echo $car[$i]->marhaba_air_code_id;?>" <?php if($car[$i]->marhaba_air_code_id == $marhaba_service->airport_code){ echo "selected='selected'"; } ?>><?php echo $car[$i]->marhaba_air_code ; ?></option>
            <?php	
            }
            }
            ?>      
        ...
        <textarea rows="3" cols="25" name="description"><?php if(isset($marhaba_service->description)) echo $marhaba_service->description; ?></textarea>
        ...
        <textarea rows="3" cols="25" name="nbr_of_pax"><?php if(isset($marhaba_service->nbr_of_pax)) echo $marhaba_service->nbr_of_pax; ?></textarea>&nbsp;&nbsp;
        <span style="color:#FF0000;"> <?php echo form_error('nbr_of_pax');?></span>
        </td>
        </tr>
        <tr height="35">
        <td width="300">Corp Rates (AED):</td>
        <td><input  value="<?php if(isset($marhaba_service->corp_rates)) echo $marhaba_service->corp_rates; ?>" name="corp_rates" id="datepicker1"  required type="text" class="b2b-txtbox" />&nbsp;&nbsp;
