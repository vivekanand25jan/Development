...
<div style="margin-top:20px;">
    ...
    <form name="form1" action="<?php echo WEB_URL; ?>index/add_excursion_details/<?php echo $this->uri->segment(3); ?>" method="post" enctype="multipart/form-data">
    ...
    <table width="780" border="0" cellspacing="1" cellpadding="0"><caption><h4 align="left">Excursion Information</h4></caption>
       ...
       <td width="77%"> <select name="supplier_name[]" id="supplier_name" style="width:170px;" multiple="multiple"  required >
        	...
        	<tr height="35">
                ...
                <td><input type="text" name="excursion_name" size="30" value="" /></td>
            </tr>
            <tr height="35">
            	<td>Description:</td>
            ...
            <tr height="35">
                <td>Minimum Pax </td>
                <td><input type="text" name="no_of_passengers" size="20" value="" />
                <span style="color:#FF0000;"> <?php echo form_error('adult');?></span></td>
            </tr>
            <tr height="35">
            
                <td valign="top">Pickup Time:</td>
                <td><input type="text" name="pickup_time" size="20" /></td>
            </tr>
     	
            <tr height="35">
            
                <td valign="top">Duration:</td>
                <td><input type="text" name="duration" size="20" /></td>
            </tr>
            <tr height="35">
            
                <td valign="top">Price for Adult:</td>
                <td><input type="text" name="adult_price" size="20" />  AED</td>
            </tr>
             <tr height="35">
            
                <td valign="top">Price for Child:</td>
                <td><input type="text" name="child_price" size="30" />  AED</td>
            </tr>
