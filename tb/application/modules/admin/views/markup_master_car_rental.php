...
<div class="panes" style="padding-bottom:10px">
	<div id="containerdount1" class="admin-innerbox">
       <div style="float:right; height:20px;"><a href="<?php echo site_url('index/markup_car_rental_period/')?>" style="color:#099;">Go Back</a></div>
       
       <div style="clear:both;"></div>
         <div style="float:right;"><a href="<?php  echo site_url('index/add_car_markup')?>/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>" style="color:#099;">Add Markkup</a></div>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" style="background-color:#E8E5E5">
  ...
  <tr>
    ...
    <td align="center" class="admin-table-colo">Car Type</td>
...
for($i=0;$i<count($car_markup);$i++)
{
   ...
   <tr >
    ...
    <td align="center" class="admin-table-colo1"><?php echo $this->Supplier_Model->get_car_type_info_new($car_markup[$i]->sup_car_type_id); ?></td>
    ...
    <a href="<?php echo WEB_URL; ?>index/update_car_markup/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>/<?php echo $car_markup[$i]->sup_car_markup_id; ?>/1">Active</a> / 
    <a href="<?php echo WEB_URL; ?>index/update_car_markup/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>/<?php echo $car_markup[$i]->sup_car_markup_id; ?>/0">InActive</a>/ 
    <a href="<?php echo WEB_URL; ?>index/update_car_markup/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>/<?php echo $car_markup[$i]->sup_car_markup_id; ?>/2">Delete</a></td>
  </tr>
 <?php
}
  }
