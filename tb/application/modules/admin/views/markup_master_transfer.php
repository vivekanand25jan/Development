...
<div class="panes" style="padding-bottom:10px">
	<div id="containerdount1" class="admin-innerbox">
       <div style="float:right; height:20px;"><a href="<?php echo site_url('index/markup_transfer_period/')?>" style="color:#099;">Go Back</a></div>
       <div style="clear:both;"></div>
         <div style="float:right;"><a href="<?php echo site_url('index/add_transfer_markup/')?>/<?php echo $this->uri->segment(3);?>" style="color:#099;">Add Markkup</a></div>
...
for($i=0;$i<count($car_markup);$i++)
{
   ...
   <tr >
    ...
    <td align="center" class="admin-table-colo1"><?php echo $this->Supplier_Model->get_tr_type_info_new($car_markup[$i]->sup_transfer_id); ?></td>
    ...
    <a href="<?php echo WEB_URL; ?>index/update_transfer_markup/<?php echo $this->uri->segment(3);?>/<?php echo $car_markup[$i]->sup_transfer_markup_id; ?>/1">Active</a> / 
    <a href="<?php echo WEB_URL; ?>index/update_transfer_markup/<?php echo $this->uri->segment(3);?>/<?php echo $car_markup[$i]->sup_transfer_markup_id; ?>/0">InActive</a>/ 
    <a href="<?php echo WEB_URL; ?>index/update_transfer_markup/<?php echo $this->uri->segment(3);?>/<?php echo $car_markup[$i]->sup_transfer_markup_id; ?>/2">Delete</a></td>
  </tr>
 <?php
}
  }
