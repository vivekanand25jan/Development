...
<div style="margin-top:20px;">
    ...
    <form  action="<?php echo WEB_URL; ?>index/update_agent_offer/<?php echo $this->uri->segment(3); ?>"  method="post" name="offer_form" id="offer_form">
  ...
  <textarea cols="80" id="area2" name="offer_content" rows="10"><?php echo $edited_offer[0]->offer_content; ?></textarea>
  </td>
  </tr>
 ...
 <strong>Agency Names: 
  ...
  {
	   $agentid = $agent_det[$i]->agent_id;
	   $offer_id = $edited_offer[0]->offer_id;
	   $agent_offer = $this->admin_model->check_agent_offer($agentid,$offer_id);
  ?>
  <input type="checkbox"  name="agent_id[]" id="agnet_id" value="<?php echo $agent_det[$i]->agent_id;  ?>"  <?php if(!empty($agent_offer)) { echo 'checked="checked"';} ?>/>
