              ...
              <tr>
                <td><table width="600" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <?php
				     ...
				     echo $refno=$result_view->booking_ref_no;  
				   ?>
					</strong>
</td>
                  </tr>
                  <tr>
                    <td width="159" class="infor_contanerader_text1">Your Reference :</td>
                    <td class="infor_contanerader_text1"> 
                  <?php
				   echo $result_view->agent_ref;
				   ?>
				  ...
				  if($att_cust!='success')
				  {
                   ...
                   <tr>
                    ...
                    <td  valign="middle">
					<form action="<?php print WEB_URL_ADMIN.'admin/attach_mail'; ?>" method="post">
					<input type="text" name="attach_mail"  /><input type="hidden" value="<?php echo  $result_view->booking_no; ?>" name="book_id" />
...
<td><?php  
					if($star_rate!=0)
					{
						for($j=1;$j<=$star_rate; $j++){ ?>			
						
															
							<span class="star_rating_icon"><img src="<?php print WEB_DIR_ADMIN?>images/star_dark.jpg" alt="" /></span>
						<?php
						if($j==5){
						break;
						}
					...
					{
						?>
							<span class="star_rating_icon">Nil</span>
					<?php
					}
						 ?></td>
                  </tr>
  ...
  ?>
             ...
             <tr>
              ...
              <tr>
				...
				<?php //echo $this->session->userdata('cont_remarks');
				echo $result_view->remark; ?>
                </strong></td>
              </tr>
              <tr>
                <td height="5">&nbsp;</td>
              ...
              <tr>
                <td height="30" bgcolor="#0094DB"class="infor_contanerader_header"><strong>&nbsp;&nbsp;&nbsp;&nbsp;Company Policy
                </strong></td>
              </tr> 
               <tr>
                <td height="5">&nbsp;</td>
        ...
        <tr>
                <td class="infor_contanerader_text1"><strong><?php echo
				$result_view->comp_pol; ?>
                </strong></td>
              </tr>
               <tr>
                <td height="5">&nbsp;</td>
...
function newPopup(url) {
	popupWindow = window.open(
		url,'popUpWindow','height=700,width=800,left=10,top=10,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes')
                 ...
                 <td width="190" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;<?php if($status!='Cancelled'){ ?><a href="<?php print WEB_URL_ADMIN.'admin/cancel_booking/'.$result_view->booking_no; ?>" onclick="return confirm('Are You Sure You want Cancel this booking?')"><input type="image" src="<?php print WEB_DIR_ADMIN; ?>images/cancel_booking.png"/></a><?php } ?></td>
