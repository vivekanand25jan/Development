...
display: none;
              ...
              <tr>
                <td><table width="600" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td class="infor_contanerader_text1"><?php echo $address=$result_view->address; ?> </td>
                  </tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="380" valign="top"><table width="378" border="0" cellspacing="1" cellpadding="0">
                      ...
                      <tr>
                        <td height="22" bgcolor="#DFDFDF"><span class="infor_contanerader_text1">Confirmation Status</span></td>
                        <td bgcolor="#DFDFDF"><span class="infor_contanerader_text1"><?php echo $status; ?></span></td>
                      </tr>                      
                    </table></td>
  ...
  ?>
						 ...
						 <?php foreach($paxname as $get_guest_ac)
						   ...
						   ?>
                      <tr>
                        <td height="22" bgcolor="#DFDFDF"><span class="infor_contanerader_text1"> <?php echo $gender.' '.$get_guest_ac->fname.' '.$get_guest_ac->lname; ?>   
              ...
              <tr>
                <td class="infor_contanerader_text1"> <strong>FOR SUPPLIER USE ONLY: THIS SERVICE IS PAYABLE BY GTA .ONLY PAYMENT FOR EXTRAS TO BE COLLECTED ROM THE CLIENT
                </strong></td>
              </tr>
