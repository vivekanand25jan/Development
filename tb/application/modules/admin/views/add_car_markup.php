...
<div class="panes" style="padding-bottom:10px">
	<div id="containerdount1" class="admin-innerbox">
       <div style="float:right; height:20px;"><a href="<?php echo site_url('index/view_car_markup_details/')?>/<?php echo $this->uri->segment(3); ?>/<?php  echo $this->uri->segment(4); ?>" style="color:#099;">Go Back</a></div>
       <div style="clear:both;"></div>
        
    	

<form  action="<?php echo WEB_URL; ?>index/add_car_markup_details/<?php echo $this->uri->segment(3); ?>/<?php  echo $this->uri->segment(4); ?>" method="post"  name="gen" >
 

<table width="100%" border="0" cellpadding="3" cellspacing="0" style="margin-top:25px; line-height:50px">
	
  <tr>
    <td class="my_profile_name" colspan="5" >Generic (Car Type  & Supplier Based)</td></tr><tr>
    ...
    <td class="my_profile_name">Car Type</td>
    <td><select name='sup_car_type_id'  class="ma_book_txt_fl_jumb1"  id='sup_car_type_id' style="height:28px" required>
    				<option value="">select</option>
					<?php
							for ($i = 0; $i < count($car_type); $i++) {
								echo "<option value='" . $car_type[$i]->sup_car_type_id. "'>" . $car_type[$i]->car_type;"</option>";
							}
						?>	
					</select></td>
