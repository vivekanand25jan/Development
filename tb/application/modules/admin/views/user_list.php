...
<ul class="tabs" style="position:relative; top:-4px; left:-3px; border-bottom:none">
	<li><a href="javascript:void(0)" style="border-radius:8px 0 0 0">Users List (<?php echo $status_cnt->tot_agent; ?>)</a></li>
	<li><a href="javascript:void(0)">Active Users  (<?php echo $status_cnt->active; ?>)</a></li>
   ...
   if(isset($result[0]))
{
  ...
  <td align="center" class="admin-table-colo1"><?php echo $i+1; ?></td>
    <td align="center" class="admin-table-colo1"><?php echo $result[$i]->user_id; ?></td>
    ...
    <td class="admin-table-colo1"><a href="<?php echo WEB_URL; ?>index/update_user/<?php echo $result[$i]->user_id; ?>/1">Active</a> / <a href="<?php echo WEB_URL; ?>index/update_user/<?php echo $result[$i]->user_id; ?>/0">InActive</a></td>
  </tr>
  <?php
  }
}
  ...
  if(isset($result_a[0]))
{
  ...
  <td align="center" class="admin-table-colo1"><?php echo $j+1; ?></td>
    <td align="center" class="admin-table-colo1"><?php echo $result_a[$j]->user_id; ?></td>
   ...
   <td class="admin-table-colo1"><a href="<?php echo WEB_URL; ?>index/edit_user/<?php echo $result_a[$j]->user_id; ?> ">Edit</a> &nbsp;&nbsp;<img src="<?php echo WEB_DIR ?>images/edit-icon.png" border="0" /></td>
    <td class="admin-table-colo1"><a href="<?php echo WEB_URL; ?>index/delete_user/<?php echo $result_a[$j]->user_id; ?> ">Delete</a> &nbsp;&nbsp;<img src="<?php echo WEB_DIR ?>images/delete-icon.png" border="0" /></td>
    <td align="center" class="admin-table-colo1"><a href="<?php echo WEB_URL; ?>index/view_booking/<?php echo $result_a[$j]->user_id; ?>">View</a> </td>
  </tr>
  <?php
  }
}
