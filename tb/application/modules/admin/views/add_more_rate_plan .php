        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <td width="77%"><select name='market_id[]' id='market_id' style="width:150px;" multiple="multiple" required>
               ...
               <?php
                ...
                if(isset($market[0]->market_id))
                    ...
                    ?>
                      <option value="<?php if(isset($results[$a]->market_id) && $results[$a]->market_id==$market[$i]->market_id) { echo $results[$a]->market_id;} else {echo $market[$i]->market_id; }?>"><?php if(isset($results[$a]->market_id) && $results[$a]->market_id==$market[$i]->market_id) { echo $market[$a]->market_name; } else { echo $market[$i]->market_name; }?></option>
                    <?php	
                    }
                    }
                    ?>          
            ...
            <tr height="35">
                ...
                <td><select name="occupancy" id="occupancy" style="width:150px;" required>
                    ...
                    //for($j=1;$j<=20;$j++){
                    ?>
                      <option value="<?php echo $results[$a]->occupancy; ?>" <?php echo $results[$a]->occupancy; ?></option>
					<?php	
                    //}
                    ?>
            ...
            <tr height="35">
                ...
                <td>
                 ...
                 <input type="text" id="no_of_adults" name="no_of_adults" value="<?php echo $results[$a]->adult; ?>" />
             <span style="color:#FF0000;"> <?php echo form_error('no_of_adults');?></span></td>
            </tr>
            <tr height="35">
                <td>Child: </td>
                <td>
                  <input type="text" id="no_of_childs" name="no_of_childs" value="<?php echo $results[$a]->child; ?>" />
                
                &nbsp; Below <input type="text" id="child_below_age" name="child_below_age" value="<?php echo $results[$a]->child_below_age; ?>" size="5"/> age<span style="color:#FF0000;"> <?php echo form_error('child');?></span></td>
            </tr>
            <tr height="35">
                <td>&nbsp; </td>
               <td><span style="margin-left:150px;">&nbsp;</span> Above <input type="text" id="child_above_age" name="child_above_age" value="<?php echo $results[$a]->child_above_age; ?>" size="5"/> age&nbsp;&nbsp;&nbsp;&nbsp; charge
                <input type="text" id="child_above_age_charge" name="child_above_age_charge" value="<?php echo $results[$a]->child_above_age_charge; ?>" size="5"/>&nbsp;</td>
            </tr>
            
              <tr height="35">
                <td>Child Extra Bed Charge: </td>
                <td><input type="text" id="child_extra_bed_charge" name="child_extra_bed_charge" value="<?php echo $results[$a]->child_extra_bed_charge; ?>" /></td>
            </tr>
            
            <tr height="35">
                <td>Infant: </td>
                <td><input type="text" id="no_of_infants" name="no_of_infants" value="<?php echo $results[$a]->infant; ?>" /></td>
            </tr>
           ...
           <tr height="">
            ...
            <tr>
              ...
              <br />   
           Breakfast Type: <input type="text" name="breakfast_type" value="<?php echo $results[$a]->breakfast_type; ?>" />
           <br />
           Adult Meal Rates:- Breakfast:<input type="text" name="adult_meal_plan_breakfast_rate" size="5" value="<?php echo $results[$a]->adult_meal_plan_breakfast_rate; ?>"/>amt,
           &nbsp;Lunch:<input type="text" name="adult_meal_plan_lunch_rate" size="5" value="<?php echo $results[$a]->adult_meal_plan_lunch_rate; ?>"/>amt,
           &nbsp;Dinner:<input type="text" name="adult_meal_plan_dinner_rate"  size="5" value="<?php echo $results[$a]->adult_meal_plan_dinner_rate; ?>"/>amt    
             <br /> 
             
             Child Meal Rates:- Breakfast:<input type="text" name="child_meal_plan_breakfast_rate" size="5" value="<?php echo $results[$a]->child_meal_plan_breakfast_rate; ?>"/>amt,
           &nbsp;Lunch:<input type="text" name="child_meal_plan_lunch_rate" size="5" value="<?php echo $results[$a]->child_meal_plan_lunch_rate; ?>"/>amt,
           &nbsp;Dinner:<input type="text" name="child_meal_plan_dinner_rate"  size="5" value="<?php echo $results[$a]->child_meal_plan_dinner_rate; ?>"/>amt    
                </td>
            </tr>
...
Supplement Rate:<input type="text" name="supplement_rate" size="5" value="<?php echo $results[$a]->supplement_rate; ?>"/>amt
				</td>
            </tr>
            ...
            <tr height="35">
                ...
                <td><textarea name="remarks" id="remarks" cols="50" rows="4"><?php echo $results[$a]->remarks; ?></textarea></td>
            </tr>
            <tr><td>&nbsp;</td><td>&nbsp;</td>
            </tr>
            <tr>
