...
<ul class="tabs" style="position:relative; top:-4px; left:-3px; border-bottom:none">
	<li><a href="javascript:void(0)" style="border-radius:8px 0 0 0">B2C Booking Reports</a></li>
...
$(function() {
          ...
          <tr>
          	<td style="width:980px;">
                ...
                <tr>
                  ...
                  <td align="center" colspan="5" class="admin-table-colo-tab1" style="background-color:#517BA5; color:#FFF">Customer Information</td>
  ...
  if($result_view!='')
  {
	...
	// print_r($result_view);exit;
	   ...
	   for($i=0;$i<count($result_view);$i++)
	  {
	   ...
	   $con_i=$this->admin_model->contact_info_detail_update_new($con_id);
   	  ?>
      <tr id="result">
           <td   style="background-color:#D3FEFA;background-image:url(<?php echo WEB_DIR; ?>images/g-r.png); background-repeat:no-repeat;" class="admin-table-colo-tab"><a href="<?php echo WEB_URL; ?>index/view_book_detail/<?php echo $result_view[$i]->transaction_details_id; ?>"><?php echo $result_view[$i]->prn_no;?></a></td>
	<td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td  style="background-color:#D3FEFA"  class="admin-table-colo-tab"><a href="<?php echo WEB_URL; ?>index/view_user_id/<?php echo $result_view[$i]->transaction_details_id; ?>/<?php echo $result_view[$i]->user_id; ?>"><?php echo $con_i->first_name;?></a></td>
                  ...
                  <td style="background-color:#D3FEFA"   class="admin-table-colo-tab"><a  href="javascript:void(0);" onclick="JavaScript:newPopup('<?php echo WEB_URL; ?>index/print_voucher/<?php echo $result_view[$i]->transaction_details_id; ?>');">Voucher</a></td>
                  ...
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab">USD</td>
 	  ...
 	  for($i=0;$i<count($result_view);$i++)
	  {
	   ...
	   $con_i=$this->admin_model->contact_info_detail_update_new($con_id);
   	  ?>
      <tr id="result">
           <td class="admin-table-colo-tab"><a href="<?php echo WEB_URL; ?>index/view_book_detail/<?php echo $result_view[$i]->transaction_details_id; ?>"><?php echo $result_view[$i]->prn_no;?></a></td>
	<td class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td class="admin-table-colo-tab"><a href="<?php echo WEB_URL; ?>index/view_user_id/<?php echo $result_view[$i]->transaction_details_id; ?>/<?php echo $result_view[$i]->user_id; ?>"><?php echo $con_i->first_name;?></a></td>
                  ...
                  <td class="admin-table-colo-tab"><a  href="javascript:void(0);" onclick="JavaScript:newPopup('<?php echo WEB_URL; ?>index/print_voucher/<?php echo $result_view[$i]->transaction_details_id; ?>');">Voucher</a></td>
                  ...
                  <td  class="admin-table-colo-tab">USD</td>
