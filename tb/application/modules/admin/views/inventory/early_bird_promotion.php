...
<table width="942" border="0" align="left" cellpadding="0" cellspacing="0" style="margin:15px 0 0 17px; ">
  <tr>
    <td align="right" valign="top" class="" colspan="7" height="30"><a href="<?php echo site_url('index/add_early_bird_promotion/')?>/<?php echo $this->uri->segment(3)?>/<?php echo $this->uri->segment(4)?>" style="color:#099; font-weight:bold;">Add Early Bird Promotion</a></td>
  </tr>
   <tr>
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab">Discount/Amount</td>
  ...
  <tr>
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/view_early_bird/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>/<?php echo $result[$i]->sup_inv_cat_early_bird_id; ?>" style="text-decoration:none;color:#099; float:left;"> <?php echo $result[$i]->cat_type; ?></a>
    </td>
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit">
    <?php $fd = $result[$i]->from_date; $fds = explode("-",$fd); $from_date = $fds[2].'-'.$fds[1].'-'.$fds[0]; $td = $result[$i]->to_date; $tds = explode("-",$td); $to_date = $tds[2].'-'.$tds[1].'-'.$tds[0]; 
	...
	echo '<b>'.$from_date.'</b> To <b>'.$to_date.'</b>';	
     ...
     <td align="left" valign="top" class="my_profile_name_ex_tab_whit">
	 <?php echo $result[$i]->discount.'%'; ?> <?php $amount=$result[$i]->amount; if($amount){ ?> &nbsp;OR <?php echo $amount;}?>
     </td>
     
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php if($result[$i]->status==1) { echo 'Active'; } else { echo 'InActive'; } ?></td>
    
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit">
    <a href="<?php echo WEB_URL; ?>index/update_early_bird/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>/<?php echo $result[$i]->sup_inv_cat_early_bird_id; ?>/1" style="color:#000;">Active</a> / <a href="<?php echo WEB_URL; ?>index/update_early_bird/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>/<?php echo $result[$i]->sup_inv_cat_early_bird_id; ?>/0" style="color:#000;">InActive</a> / <a href="<?php echo WEB_URL; ?>index/update_early_bird/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>/<?php echo $result[$i]->sup_inv_cat_early_bird_id; ?>/2" style="color:#000;">Delete</a></td>
  </tr>
  <?php
	}
}
