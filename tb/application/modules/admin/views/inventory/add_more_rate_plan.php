...
<div id="containerdount"  class="tab1" style="padding-top:20px;">
 ...
 <!--<option value="<?php echo $market[$i]->market_id; ?>" <?php if(isset($results[0][0]->market_id) && $results[0][0]->market_id == $market[$i]->market_id) { echo "selected='selected'"; } ?>> <?php $market[$i]->market_name; ?> </option>-->
                    <?php	
                    }
                    //}
                    ?>          
            ...
            <tr height="35">
                ...
                &nbsp; Below <input type="text" id="child_below_age" name="child_below_age" value="<?php echo $results[0][0]->child_below_age; ?>" size="5"/> age<span style="color:#FF0000;"> <?php echo form_error('child');?></span></td>
            </tr>
            <tr height="35">
                <td>&nbsp; </td>
               <td><span style="margin-left:150px;">&nbsp;</span> Above <input type="text" id="child_above_age" name="child_above_age" value="<?php echo $results[0][0]->child_above_age; ?>" size="5"/> age&nbsp;&nbsp;&nbsp;&nbsp; charge
...
Supplement Rate:<input type="text" name="supplement_rate" size="5" value="<?php echo $results[0][0]->supplement_rate; ?>"/>amt
            ...
            <?php
            		$rate_id=$results[0][0]->sup_rate_tactics_id;
            		$sql="SELECT * FROM sup_rate_minimum_stay WHERE rate_tactics_id='".$rate_id."'";
    ...
    <td style="border-right:solid 1px #deab6f; text-align:center; padding-left:0px;"><input name="adult" id="adult" type="text" class="input-field"  style="height:20px; margin-top:3px; background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->adult;?>"/></td>
    <td style="border-right:solid 1px #deab6f; text-align:center; padding-left:0px;">   <input name="child" id="child" type="text" class="input-field"  style="height:20px; margin-top:3px; background:#F2F2F2;" size="5" value="<?php echo $results[0][0]->child;?>"/></td>
