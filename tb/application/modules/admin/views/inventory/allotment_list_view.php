...
<table width="942" border="0" align="left" cellpadding="0" cellspacing="0" style="margin:15px 0 0 17px; ">
  <tr>
    <td align="right" valign="top" class="" colspan="7" height="30"><a href="<?php echo site_url('index/add_allotment/')?>/<?php echo $this->uri->segment(3)?>/<?php echo $this->uri->segment(4)?>" style="color:#099; font-weight:bold;">Add Allotment</a></td>
  </tr>
   <tr>
  ...
  <tr>
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><a href="<?php echo WEB_URL; ?>index/view_allotment/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>/<?php echo $result[$i]->sup_inv_cat_allotment_id; ?>" style="text-decoration:none;color:#099; float:left;"> <?php echo $result[$i]->cat_type; ?></a>
    </td>
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit">
    <a href="<?php echo WEB_URL; ?>index/update_allotment_list/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>/<?php echo $result[$i]->sup_inv_cate_allotment_ref_id; ?>/1" style="color:#000;">Active</a> / <a href="<?php echo WEB_URL; ?>index/update_allotment_list/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>/<?php echo $result[$i]->sup_inv_cate_allotment_ref_id; ?>/0" style="color:#000;">InActive</a> / <a href="<?php echo WEB_URL; ?>index/update_allotment_list/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>/<?php echo $result[$i]->sup_inv_cate_allotment_ref_id; ?>/2" style="color:#000;">Delete</a></td>
  </tr>
  <?php
	}
}
