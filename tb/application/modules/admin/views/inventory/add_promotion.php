...
<?php  $period =$this->Supplier_Model->get_period_information($this->uri->segment(5));
...
<?php echo '<B>Period Information: </B>'; ?>
</div>   
...
<?php $fromD = explode('-',$period->room_avail_date_from);
    ...
    <form name="form1" action="<?php echo WEB_URL; ?>index/add_promotion/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>/<?php echo $this->uri->segment(5); ?>" method="post">
...
<input type="hidden" name="category_type"   value="<?php echo $category_type; ?>" />
    ...
    <table width="800" border="0" cellspacing="1" cellpadding="0"><caption><h4 align="left">Add Promotion</h4></caption>
