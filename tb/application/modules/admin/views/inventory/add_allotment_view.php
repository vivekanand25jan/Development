...
<div style="margin-top:20px;">
    ...
    <form name="form1" action="<?php echo WEB_URL; ?>index/add_allotment_plan/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>" method="post">
                ...
                <td>
				   ...
				   ?>
                    ...
                    ?>
                      ...
                      <!--<option value="<?php echo $cate[$i]->sup_inv_cate_type_id; ?>"><?php echo $cate[$i]->cate_type;?></option>-->
					<?php	
                    }
...
else
{
        ...
        ?>
            <input value="<?php echo $current_dte; ?>" name="sds" id="datepicker"  onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox"  style=" background-image: url('<?php echo WEB_DIR_FRONT; ?>images/b2b-calicon.png');   background-repeat: no-repeat;  background-position: right center;" /> 					
            To <input  value="<?php echo $next_dte; ?>" name="eds" id="datepicker1" onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox" style=" background-image: url('<?php echo WEB_DIR_FRONT; ?>images/b2b-calicon.png');   background-repeat: no-repeat;  background-position: right center;" /></td>
    </tr>
