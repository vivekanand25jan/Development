...
<div style="margin-top:20px;">
    ...
    <form name="AddEarlyBirdPromotion" action="<?php echo WEB_URL; ?>index/add_early_bird_plan/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>" method="post">
    ...
    <tr height="35">
                ...
                <td width="20%">
                    ...
                    ?>
                      <option value="<?php echo $cate[$i]->cate_type; ?>">
...
else
{
        ...
        ?>
            <input value="<?php echo $current_dte; ?>" name="sd" id="datepicker"  onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox"  style=" background-image: url('<?php echo WEB_DIR_FRONT; ?>images/b2b-calicon.png');   background-repeat: no-repeat;  background-position: right center;" /> 					
            To <input  value="<?php echo $next_dte; ?>" name="ed" id="datepicker1" onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox" style=" background-image: url('<?php echo WEB_DIR_FRONT; ?>images/b2b-calicon.png');   background-repeat: no-repeat;  background-position: right center;" /></td>
    </tr>
    
    <tr height="35">
    <td width="300">Discount:</td>
    <td><input type="text" id="discount" name="discount" value="" />&nbsp;%&nbsp; or
    <input type="text" id="amount" name="amount"  value="" /> Amount</td>
    </tr>
    <tr height="35">
    <td width="300">Booking Code:</td>
    <td><input type="text" name="booking_code" value=""  size="20"/></td>
    </tr>
    <tr height="35">
    <td width="300">Book Before:</td>
    <td><input value="" name="bb" id="datepicker2"  onchange="javascript:return check_night_valued(this.value)" type="text" class="b2b-txtbox"  style=" background-image: url('<?php echo WEB_DIR_FRONT; ?>images/b2b-calicon.png');   background-repeat: no-repeat;  background-position: right center;" /></td>
    </tr>
    </table>
