...
<?php $fromD = explode('-',$cate_details->room_avail_date_from);
    ...
    <td width='170px'>
        ...
        <tr height="35">
        <td>
        <input type="checkbox" id="stay_check"  onchange="getFields()" <?php if($promo_view_details->stay_nights!= ''){?> checked="checked" <?php } ?>/>&nbsp;&nbsp;&nbsp;Promotion Nights 
        </td>
        <td>
        <input type="checkbox" id="bb_check" onchange="getFields()" <?php if($promo_view_details->hh_date!= '0000-00-00'){?> checked="checked" <?php } ?>/>&nbsp;&nbsp;&nbsp;Promotion Dates 
        </td>  
        </tr>
  </table>
