...
<body>
 <div id="div_wrapper">
	...
	<li><a href="javascript:void(0)" style="border-radius:8px 0 0 0">Registration Request</a></li>
...
</div><span style=" float: right;    font-size: 14px;    margin-top: -36px;    padding: 3px;">
...
<table width="50%"   border="0" cellspacing="1" cellpadding="6">
  <tr>
    <td style="">This is a Guest Booking. If you want genereate automatic registration process, you just <a href="<?php echo WEB_URL; ?>index/send_reg_request/<?php echo $id; ?>">click here.</a></td>
