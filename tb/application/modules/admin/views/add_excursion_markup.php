...
<div class="panes" style="padding-bottom:10px">
	<div id="containerdount1" class="admin-innerbox">
       <div style="float:right; height:20px;"><a href="<?php echo site_url('index/view_ex_markup_details/')?>/<?php echo $this->uri->segment(3); ?>" style="color:#099;">Go Back</a></div>
       <div style="clear:both;"></div>
        
    	

<form  action="<?php echo WEB_URL; ?>index/add_ex_markup_details/<?php echo $this->uri->segment(3); ?>" method="post"  name="gen" >
...
<table width="100%" border="0" cellpadding="3" cellspacing="0" style="margin-top:25px; line-height:50px">
  ...
  <tr>
    ...
    <td class="my_profile_name">Excursion Name</td>
    <td><select name='sup_excursion_id'  class="ma_book_txt_fl_jumb1"  id='sup_car_type_id' style="height:28px" required>
    				<option value="">select</option>
					<?php
							for ($i = 0; $i < count($car_type); $i++) {
								echo "<option value='" . $car_type[$i]->sup_excursion_id. "'>" . $car_type[$i]->excursion_name;"</option>";
							}
						?>	
					</select></td>
