...
<div style="margin-top:5px;">
    ...
    <form name="form1" action="<?php echo WEB_URL; ?>index/add_markup_excursion_period" method="post">
...
for($i=0;$i<count($excursion_markup);$i++)
{
   ...
   <tr >
    ...
    <td align="center" class="admin-table-colo1"><a href="<?php echo WEB_URL; ?>index/edit_ex_markup_period/<?php echo $excursion_markup[$i]->excursion_markup_period_id; ?>" style="text-decoration:none;color:#099; "><?php echo $from_date .'-' .$to_date; ?></a></td>
      <td align="center" class="admin-table-colo1"><a href="<?php echo WEB_URL; ?>index/view_ex_markup_details/<?php echo $excursion_markup[$i]->excursion_markup_period_id; ?>" style="text-decoration:none;color:#099; ">Add Markup</a></td>
    ...
    <a href="<?php echo WEB_URL; ?>index/update_ex_markup_period/<?php echo $excursion_markup[$i]->excursion_markup_period_id; ?>/1 ">Active</a> / 
    <a href="<?php echo WEB_URL; ?>index/update_ex_markup_period/<?php echo $excursion_markup[$i]->excursion_markup_period_id; ?>/0">InActive</a>/ 
    <a href="<?php echo WEB_URL; ?>index/update_ex_markup_period/<?php echo $excursion_markup[$i]->excursion_markup_period_id; ?>/2">Delete</a></td>
  </tr>
 <?php
}
  }
