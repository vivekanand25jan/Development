...
<ul class="tabs" style="position:relative; top:-4px; left:-3px; border-bottom:none">
	<li><a href="javascript:void(0)" style="border-radius:8px 0 0 0">New Agent Registration</a></li>
...
<form action="<?php echo WEB_URL; ?>index/registration_page" method="post" name="profile" enctype="multipart/form-data">     
...
?>
  ...
  <tr>
    <td align="left" valign="top" class="my_profile_name">Agent Profile:</td>
  </tr>
  <tr>
...
<div class="tab_right_second">
  ...
  <tr>
   <td align="left" valign="top" class="my_profile_name"><select name="a_type" class="ma_pro_txt">
<!--   <option value="">Select Agent Type</option>
     ...
     <option value="credit">Credit Agent</option> -->    
      ...
      <option>Select</option>
		   ...
		   if(isset($agent[0]->agent_id))
                    ...
                    ?>
                      <option value="<?php echo $agent[$i]->agent_id; ?>"><?php echo $agent[$i]->agent_type ?></option>
					<?php	
                    }
					}
                    ?>
    </select><div style="color:#FF0000;"> <?php echo form_error('a_type');?></div></td>
  </tr>
  ...
  <tr>
   ...
   <td align="left" valign="top" class="my_profile_name"><select name="cc_id" class="ma_pro_txt">
  <option value="">Select Call Center</option>
     ...
     <?php
					  ...
					  ?>
    </select><div style="color:#FF0000;"> <?php echo form_error('cc_id');?></div></td>
  </tr>
   ...
   <tr>
    ...
    <input name="agent_logo_admin"  type="file" /></td>
  </tr>
...
<div class="wi_for_cancel">
  ...
  <tr>
    ...
    <td align="left" valign="top"><table width="250" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
