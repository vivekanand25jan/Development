...
<script>
function delete_supplier(booking_number)
{
if(confirm("Are you sure, you want to Delete this Supplier?")) {
	var data = "booking_number="+booking_number;
	$.ajax({
	  url:'<?php echo WEB_URL; ?>index/delete_supplier/'+booking_number, 
	  data: "",
	  dataType: "json",
	  type: 'POST',
...
<ul class="tabs" style="position:relative; top:-4px; left:-3px; border-bottom:none">
	<li><a href="javascript:void(0)" style="border-radius:8px 0 0 0">Suppliers List (<?php echo $status_cnt->tot_suppliers; ?>)</a></li>
	<li><a href="javascript:void(0)">Active Suppliers  (<?php echo $status_cnt->active; ?>)</a></li>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" style="background-color:#E8E5E5">
  <tr>
    ...
    <td class="admin-table-colo">SupplierID</td>
   ...
   if(isset($result[0]))
{
  ...
  <td align="center" class="admin-table-colo1"><?php echo $i+1; ?></td>
    ...
    <td class="admin-table-colo1"><?php if($result[$i]->active==1) { echo 'Active'; } else { echo 'InActive'; } ?></td>
   
    <td class="admin-table-colo1"><a href="<?php echo WEB_URL; ?>index/update_supplier/<?php echo $result[$i]->agent_id; ?>/1">Active</a> / <a href="<?php echo WEB_URL; ?>index/update_supplier/<?php echo $result[$i]->agent_id; ?>/0">InActive</a></td>
  </tr>
  <?php
  }
}
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" style="background-color:#E8E5E5">
  ...
  <td class="admin-table-colo">No </td>
    ...
    <td class="admin-table-colo">View Hotels</td>
  ...
  if(isset($result_a[0]))
{
  ...
  <td align="center" class="admin-table-colo1"><?php echo $j+1; ?></td>
    ...
    <!--<td class="admin-table-colo1"><?php echo $result_a[$j]->balance_credit.' USD'; ?></td>
    <td class="admin-table-colo1"><a href="<?php echo WEB_URL; ?>index/deposit_details/<?php echo $result_a[$j]->agent_id; ?> ">Deposit</a> &nbsp;&nbsp;</td>-->
   
     <td class="admin-table-colo1" valign="top"><a href="<?php echo WEB_URL; ?>index/edit_supplier/<?php echo $result_a[$j]->agent_id; ?> ">View</a> &nbsp;&nbsp;</td>
    <td class="admin-table-colo1"> <a href="javascript:void(0);" onclick="delete_supplier('<?php echo $result_a[$j]->agent_id; ?>');">Delete</a> &nbsp;&nbsp;</td>
    <td align="center" class="admin-table-colo1" valign="top"><a href="<?php echo WEB_URL; ?>index/view_hotels/<?php echo $result_a[$j]->agent_id; ?>">View</a> </td>
