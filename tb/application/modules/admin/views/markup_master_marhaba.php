...
<div class="panes" style="padding-bottom:10px">
	<div id="containerdount1" class="admin-innerbox">
       <div style="float:right; height:20px;"><a href="<?php echo site_url('index/markup_meetandgreet/')?>" style="color:#099;">Go Back</a></div>
       
       <div style="clear:both;"></div>
         <div style="float:right;"><a href="<?php  echo site_url('index/add_marhaba_markup')?>/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>" style="color:#099;">Add Markkup</a></div>
    	

<div id="g_result" style=" width:100%">
<span>Description : <span style="color:#009999; font-weight:bold;"><?php echo substr($result->description,0,25); ?></span></span></br></br>
<span>Description Category :<span style="color:#009999; font-weight:bold;"><?php echo $this->Supplier_Model->get_cate_marbha($result->desc_cate); ?></span></span>
...
for($i=0;$i<count($car_markup);$i++)
{
   ...
   <tr >
    ...
    <a href="<?php echo WEB_URL; ?>index/update_marhabha_markup/<?php echo $this->uri->segment(3);?>/<?php echo $car_markup[$i]->sup_marhaba_markup_id 	; ?>/1">Active</a> / 
    <a href="<?php echo WEB_URL; ?>index/update_marhabha_markup/<?php echo $this->uri->segment(3);?>/<?php echo $car_markup[$i]->sup_marhaba_markup_id 	; ?>/0">InActive</a>/ 
    <a href="<?php echo WEB_URL; ?>index/update_marhabha_markup/<?php echo $this->uri->segment(3);?>/<?php echo $car_markup[$i]->sup_marhaba_markup_id 	; ?>/2">Delete</a></td>
  </tr>
 <?php
}
  }
