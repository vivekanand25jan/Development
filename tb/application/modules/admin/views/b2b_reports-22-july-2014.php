...
<div style="float:left; width:200%; padding-bottom:85px; position:absolute; margin-top:10px;">
  ...
  if($result_view!='')
  {
	...
	<td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td  style="background-color:#D3FEFA" class="admin-table-colo-tab"><?php echo $aa =($result_view[$i]->cancelled_charge!='')?$result_view[$i]->cancelled_charge:($result_view[$i]->amount-$result_view[$i]->markup);?></td>
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab">AED</td>
	...
	<td class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td class="admin-table-colo-tab"><?php echo $con_i->city;?></td>
                   ...
                   <td class="admin-table-colo-tab"><a href="<?php echo WEB_URL; ?>index/cancel_booking/<?php echo $result_view[$i]->hotel_booking_id; ?>">Cancel</a></td>
                   <td class="admin-table-colo-tab"><a href="<?php echo WEB_URL; ?>index/send_voucher/<?php echo $result_view[$i]->hotel_booking_id; ?>">Mail</a></td>
                  ...
                  <td class="admin-table-colo-tab"><?php echo $result_view[$i]->booking_number;?></td>
                   ...
                   <td class="admin-table-colo-tab"><?php echo $aa =($result_view[$i]->cancelled_charge!='')?$result_view[$i]->cancelled_charge:($result_view[$i]->amount-$result_view[$i]->markup);?></td>
                  <td  class="admin-table-colo-tab">AED</td>
                  <td   class="admin-table-colo-tab"><?php echo $result_view[$i]->amount;?></td>
                  <td  class="admin-table-colo-tab"><?php echo $result_view[$i]->markup; ?></td>
