...
<body>
 <div id="div_wrapper">
	...
	<li><a href="javascript:void(0)" style="border-radius:8px 0 0 0">API Manage</a></li>
...
<table width="50%"   border="0" cellspacing="1" cellpadding="6">
  <tr>
    <td style="background-color:#517BA5; color:#FFF">API</td>
    <td style="background-color:#517BA5; color:#FFF">Status</td>
  ...
  <tr>
    <td><?php echo $result[$i]->api_name; ?></td>
    <td><?php if($result[$i]->active ==1) { echo 'Active'; } else { echo 'InActive'; } ?></td>
    <td><?php echo "<a href='". WEB_URL . "index/edit_api/" . $result[$i]->api_id . "/1'>Active</a>";	 ?>
						/ <?php echo "<a href='". WEB_URL . "index/edit_api/" . $result[$i]->api_id . "/0'>InActive</a>";	 ?>
						</td>
  </tr>
  <?php
					}
