		...
		$("#result").empty().html('<div style="padding-left:400px" align="middle"><img src=\'<?php print WEB_DIR ?>images/ajax-loader(2).gif\'></div>');
		  $("#result").load("<?php print WEB_URL ?>account/booking_search/"+sd+"/"+ed+"/"+bookno+"/"+status);
		       ...
		       return false;
                     ...
                     <div id="navjam">
<ul class="tabs">
	<li style=" width:800px;"><a href="javascript:void(0)">Edit Profile</a></li>
...
<form action="<?php echo WEB_URL; ?>index/my_account_update_agent/<?php echo $id; ?>" method="post" name="profile" enctype="multipart/form-data">     
<div class="tab_right_section">
  ...
  <tr>
    <td align="left" valign="top" class="my_profile_name"><input name="fname" type="text" class="ma_pro_txt" value="<?php echo $profile->name; ?>" /></td>
  </tr>
   <tr>
    <td align="left" valign="top" class="account_font_pos_r">
      Company Name
  ...
  <tr>
    <td align="left" valign="top" class="my_profile_name"><input name="lname" type="text" class="ma_pro_txt" value="<?php echo $profile->company_name; ?>" /></td>
  </tr>
   <tr>
    <td align="left" valign="top" class="account_font_pos_r">
    Mobile Phone Number
...
<div class="tab_right_section"><table width="300" border="0" align="left" cellpadding="0" cellspacing="0" style="margin:20px 0 0 0;">
  ...
  <tr>
   <td align="left" valign="top" class="my_profile_name"><input name="ph_no" type="text"  value="<?php echo $profile->office_phone 	; ?>" class="ma_pro_txt" /></td>
  </tr>
   <tr>
    <td align="left" valign="top" class="account_font_pos_r">
    Adddress
  ...
  <tr>
    ...
    <div class="tab_right_second">
		<table width="300" border="0" align="left" cellpadding="0" cellspacing="0" style="margin:20px 0 0 0;">
  <tr>
    <td align="left" valign="top" class="my_profile_name">Market Information: </td>
  </tr>
   <tr>
    <td align="left" valign="top" class="account_font_pos_r">
    Markets:
    </td>
    <td align="left" valign="top" class="my_profile_name"><select name='market_id[]' id='market_id' style="width:150px;" multiple="multiple" required>
                <option value="">Select</option>
               <?php
                $market = $this->Supplier_Model->get_market_available();
                $market_data = explode(',',$profile->markets);
                if(isset($market[0]->market_id))
                    {
                    for($i=0;$i<count($market);$i++){
                        if(in_array($market[$i]->market_id,$market_data)!==FALSE){
                    ?>
                      <option value="<?php echo $market[$i]->market_id; ?>" selected="selected"><?php echo $market[$i]->market_name; ?></option>
                    <?php	
                    }else{
                     ?>
	...
	<div style="color:#FF0000;"> <?php echo form_error('market_id');?></div></td>
  </tr>  
</table>
</div>
    <!-- MARKET HTML END HERE -->
...
<div class="tab_right_second">
  ...
  <tr>
    <td align="left" valign="top" class="my_profile_name">
    <select name="d_type" class="ma_pro_txt">
   ...
   <!-- <?php 
	...
	?>
     -->
      <option value="">Select</option>
           <?php
		   $agent = $this->Supplier_Model->get_agent();
		   
		   if(isset($agent[0]->agent_id))
					{
                    for($i=0;$i<count($agent);$i++){
                    ?>
                      <option value="<?php echo $agent[$i]->agent_id; ?>"<?php if($agent[$i]->agent_id == $profile->agent_mode){ echo "selected='selected'"; } ?>><?php echo $agent[$i]->agent_type ?></option>
					<?php	
                    }
					}
                    ?>
  ...
  <tr>
    ...
    <tr>
    <td align="left" valign="top" class="my_profile_name"><input name="agent_edit_logo" type="file" /></td>
  </tr>
  
   <tr>
    <td align="left" valign="top" class="my_profile_name">
	<?php if(isset($profile->agent_logo)) { ?>
   <div style="float:left;"> 
   <img src="<?php echo WEB_DIR_FRONT ?>agent_logos/<?php echo $profile->agent_logo; ?>" width="240" height="140" border="0" />
   </div>
   <?php } ?></td>
  </tr>
