...
<div style="float:left; width:200%; padding-bottom:85px; position:absolute; margin-top:10px;">
  ...
  { 
	...
	<td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td  style="background-color:#D3FEFA" class="admin-table-colo-tab"><?php echo $aa =($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?$result_view[$i]->cancelled_charge:($result_view[$i]->amount+$net_for_admin);?></td>
                  ...
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $net_amount = ($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?($net_after_cancel+$net_for_admin1):($namount)+$net_for_admin;?></td>
	...
	<td class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $net_amount = ($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?($net_after_cancel+$net_for_admin1):($namount)+$net_for_admin;?></td><?php /* *$result_view[$i]->currency_val */ ?>
                  <td  style="background-color:#D3FEFA" class="admin-table-colo-tab"><?php echo $net_profit = ($aa-$net_amount); ?></td>
