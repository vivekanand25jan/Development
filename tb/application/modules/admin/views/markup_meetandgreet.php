...
<table width="100%" border="0" cellspacing="1" cellpadding="0" style="background-color:#E8E5E5">
  ...
  <tr>
 	...
 	<td align="center" class="admin-table-colo">Description</td>
     <td align="center" class="admin-table-colo">Description Category</td>
  ...
  for($i=0;$i<count($result);$i++)
  {
   ...
   <tr >
    ...
    <td align="center" class="admin-table-colo1" style="text-align:left;"><?php echo $result[$i]->description; ?></td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php echo $result[$i]->marhaba_desc_cate_name; ?></a></td>
      <td align="center" class="admin-table-colo1"><a href="<?php echo WEB_URL; ?>index/view_marhaba_markup_details/<?php echo $result[$i]->marhaba_services_id; ?>" style="text-decoration:none;color:#099; ">Add Markup</a></td>
