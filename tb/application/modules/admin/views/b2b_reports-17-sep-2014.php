...
<div style="float:left; width:200%; padding-bottom:85px; position:absolute; margin-top:10px;">
  ...
  { 
	...
	for($nth=0;$nth<count($extra);$nth++){ $ext_pric[]=$extra[1];$ext_pri+=$extra[1];}
   	  ?>
      <tr id="result">
	...
	<td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td  style="background-color:#D3FEFA" class="admin-table-colo-tab"><?php echo $con_i->city;?></td>
                   ...
                   <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><a href="<?php echo WEB_URL; ?>index/cancel_booking/<?php echo $result_view[$i]->hotel_booking_id; ?>">Cancel</a></td>
                   <td  style="background-color:#D3FEFA"  class="admin-table-colo-tab"><a href="<?php echo WEB_URL; ?>index/send_voucher/<?php echo $result_view[$i]->hotel_booking_id; ?>">Mail</a></td>
                  ...
                  <td  style="background-color:#D3FEFA" class="admin-table-colo-tab"><?php echo $aa =($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?$result_view[$i]->cancelled_charge*$result_view[$i]->currency_val:($result_view[$i]->amount);?></td>
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->xml_currency;?></td>
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $net_amount = ($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?$result_view[$i]->cancelled_charge*$result_view[$i]->currency_val-$net_after_cancel:($namount)+array_sum($extra);?></td>
...
$night_char = array_sum(explode(',',$result_view[$i]->daily_rates));
	$extra = explode("--",$result_view[$i]->extra_services);$ext_prii=0;
	for($nth = 0;$nth<count($extra);$nth++){ $ext_prii+=$extra[1];}
   	  ?>
      <tr id="result">
	...
	<td class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td  style="background-color:#D3FEFA" class="admin-table-colo-tab"><?php echo $aa =($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?$result_view[$i]->cancelled_charge*$result_view[$i]->currency_val:($result_view[$i]->amount);?></td>
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->xml_currency;?></td>
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $net_amount = ($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?$result_view[$i]->cancelled_charge*$result_view[$i]->currency_val:($night_char)+$ext_prii;?></td>
                  <td  style="background-color:#D3FEFA" class="admin-table-colo-tab"><?php echo $net_profit = ($aa-$net_amount); ?></td>
...
$extra = explode("--",$result_view[$i]->extra_services);$ext_priiii=0;
	...
	<td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->xml_currency;?></td>
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->amount;?></td>
...
$extra = explode("--",$result_view[$i]->extra_services);$ext_pris=0;
	...
	<td class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td  style="background-color:#D3FEFA" class="admin-table-colo-tab"><?php echo $aa =($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?$result_view[$i]->cancelled_charge*$result_view[$i]->currency_val:($result_view[$i]->amount);?></td>
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->xml_currency;?></td>
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $net_amount = ($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?$result_view[$i]->cancelled_charge*$result_view[$i]->currency_val:($result_view[$i]->net_amount*$result_view[$i]->currency_val)+$ext_pris;?></td>
                  <td  style="background-color:#D3FEFA" class="admin-table-colo-tab"><?php echo $net_profit = ($aa-$net_amount); ?></td>
