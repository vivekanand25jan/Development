...
<body>
 <div id="div_wrapper">
	...
	<li><a href="javascript:void(0)" style="border-radius:8px 0 0 0">Send Voucher</a></li>
...
<table width="50%"   border="0" cellspacing="1" cellpadding="6">
 ...
 <form action="<?php echo site_url('index/send_mail/'); ?>" method="post">
  <tr>
    <td><input type="text" style="width:250px" name="mail"  /></td>
