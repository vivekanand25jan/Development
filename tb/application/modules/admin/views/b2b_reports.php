  ...
  { 
	   for($i=0;$i<count($result_view);$i++)
	  {
	   ...
	   $cancel_for_dates = $result_view[$i]->cancel_for_dates;
           ...
           $net_for_admin1 = ($result_view[$i]->check_per==420)?array_sum(explode(',',$result_view[$i]->extra_service_admin)):0;

	  //$net_after_cancel = (($markup_s/$b_nights)*$cancel_for_dates)*$result_view[$i]->currency_val;
	  $net_after_cancel = $result_view[$i]->cancel_amount_admin;
	...
	for($nth=0;$nth<count($extra);$nth++){ $cc = explode('--',$extra[$nth]);$ext_pric[]=$cc[1];$ext_pri+=$cc[1];}
        ...
        $ex_pri = $ext_pri-$net_for_admin;
   	  ?>
      <tr id="result">
           <td   style="background-color:#D3FEFA;background-image:url(<?php echo WEB_DIR; ?>images/g-r.png); background-repeat:no-repeat;" class="admin-table-colo-tab"><a href="<?php echo WEB_URL; ?>index/view_book_detail/<?php echo $result_view[$i]->hotel_booking_id; ?>"><?php //echo $result_view[$i]->prn_no;?> <?php echo $result_view[$i]->booking_number; ?></a></td>
	<td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td style="background-color:#D3FEFA"   class="admin-table-colo-tab"><a  href="javascript:void(0);" onclick="JavaScript:newPopup('<?php echo WEB_URL; ?>index/booking_number/<?php echo $result_view[$i]->hotel_booking_id; ?>');">Voucher</a> / <a  href="javascript:void(0);" onclick="JavaScript:newPopup('<?php echo WEB_URL; ?>index/invoice_print/<?php echo $result_view[$i]->hotel_booking_id; ?>');">Invoice</a></td>
				  ...
				  $a = explode("-",$result_view[$i]->room_type);
                   if($result_view[$i]->no_of_room==1){         
					$admin_last_am = $namount+$net_for_admin;
					}else{
						$admin_last_am = $result_view[$i]->net_amount+$net_for_admin;
					}
                  $sub_am='';          
                   if($result_view[$i]->earlyBirdPer!='' && $result_view[$i]->earlyBirdPer!='NULL'){
					$sub_am = $admin_last_am-$admin_last_am*($result_view[$i]->earlyBirdPer/100);
					}
					if($result_view[$i]->earlyBirdAmt!='' && $result_view[$i]->earlyBirdAmt!='NULL'){
						$sub_am =  $admin_last_am-$result_view[$i]->earlyBirdAmt;
						
					} 
					
					$sub_am = ($sub_am!='')?$sub_am:$admin_last_am;         
			  
				  ?>
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->no_of_room;?></td>
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->room_type;?></td>
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->special_offer;?></td>
                   <td  style="background-color:#D3FEFA" class="admin-table-colo-tab"><?php echo $result_view[$i]->status;?></td>
                  ...
                  <td  style="background-color:#D3FEFA" class="admin-table-colo-tab"><?php echo $aa =($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?$result_view[$i]->cancelled_charge:($result_view[$i]->amount+$net_for_admin1);?></td>
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->xml_currency.'1';?></td>
                  ...
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $net_amount = ($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?($net_after_cancel+$net_for_admin1):$sub_am;?></td>
	...
	for($nth=0;$nth<count($extra);$nth++){ $cc = explode('--',$extra[$nth]);$ext_pric[]=$cc[1];$ext_pri+=$cc[1];}
	   ...
	   for($nth=0;$nth<count($extra);$nth++){ $cc = explode('--',$extra[$nth]);$ext_pric[]=$cc[1];$ext_pri+=$cc[1];}
   	  ...
   	  ?>
      <tr id="result">
           <td class="admin-table-colo-tab"><a href="<?php echo WEB_URL; ?>index/view_book_detail/<?php echo $result_view[$i]->hotel_booking_id; ?>"><?php //echo $result_view[$i]->prn_no;?> <?php echo $result_view[$i]->booking_number; ?></a></td>
	<td class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td class="admin-table-colo-tab"><?php echo $result_view[$i]->room_type;?></td>
                  <td class="admin-table-colo-tab"><?php echo $result_view[$i]->special_offer;?></td>
                   <td class="admin-table-colo-tab"><?php echo $result_view[$i]->status;?></td>
                  ...
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->xml_currency.'2';?></td>
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $net_amount = ($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?($net_after_cancel+$net_for_admin1):$sub_am;?></td><?php /* *$result_view[$i]->currency_val */ ?>
                  <td  style="background-color:#D3FEFA" class="admin-table-colo-tab"><?php echo $net_profit = ($aa-$net_amount); ?></td>
