...
<table width="100%" border="0" cellspacing="7" cellpadding="3" class="r-hoteldeta">
          ...
          <tr>
           ...
           <tr>
          	<td colspan="2" ><span style="font-size:15px; color:#069;">Booking Status : <?php echo $trans->status; ?></span>

			<a href="<?php echo WEB_URL; ?>index/change_booking_status/<?php echo $trans->transaction_details_id; ?>">Change Status</a>
         ...
         <td align="left">
         	<div style="width:878px; margin:0 auto;">
                ...
                <div style="width:907px; float:left">
                	<p class="mid-txt">Hotel Name : <?php echo $result_view->hotel_name; ?> 
                ...
                <div style="width:505px; float:left" class="mid-txt">: <?php echo $result_view->address; ?></div>
            	</div>
                
                <div class="hotelfa-div" style="border:none">
            	<div style="width:150px; float:left;">City  </div>
                <div style="width:505px; float:left" class="mid-txt">: <?php echo $result_view->city; ?>	</div>
            	</div>
  ...
  <tr>
    <td style="border-bottom: 1px solid #9D9D9D;border-right: 1px solid #9D9D9D;"><?php echo $trans->net_amount; ?></td>
    <td style="border-bottom: 1px solid #9D9D9D;border-right: 1px solid #9D9D9D;"><?php echo $trans->xml_currency; ?></td>
    <td style="border-bottom: 1px solid #9D9D9D;border-right: 1px solid #9D9D9D;"><?php echo $trans->currency_val; ?></td>
     <td style="border-bottom: 1px solid #9D9D9D;border-right: 1px solid #9D9D9D;"><?php echo $trans->amount-$trans->markup-$trans->gateway; ?></td>
  ...
  <tr>
    <td style="border-bottom: 1px solid #9D9D9D;border-right: 1px solid #9D9D9D;"><?php echo $result_view->no_of_room; ?></td>
    <td style="border-bottom: 1px solid #9D9D9D;border-right: 1px solid #9D9D9D;"><?php echo $trans->amount-$trans->markup-$trans->gateway; ?></td>
    <td style="border-bottom: 1px solid #9D9D9D;border-right: 1px solid #9D9D9D;"><?php echo $trans->markup; ?></td>
     <td style="border-bottom: 1px solid #9D9D9D;border-right: 1px solid #9D9D9D;"><?php echo $trans->gateway; ?></td>
     <td style="border-bottom: 1px solid #9D9D9D;border-right: 1px solid #9D9D9D;"><?php echo $trans->markup+$trans->gateway; ?></td>
    <td style="border-bottom: 1px solid #9D9D9D;"><?php echo $trans->amount; ?></td>
  </tr>
  <tr><td colspan="6">&nbsp;</td>
  <tr>
    <td>&nbsp;</td>
    ...
    <td><?php echo $trans->amount; ?> AED</td>
  </tr>
</table>
...
-->
    <td style="border-bottom: 1px solid #9D9D9D;border-right: 1px solid #9D9D9D;"><?php echo $trans->cancellation_till_date; ?></td>
<!--
    <td style="border-bottom: 1px solid #9D9D9D;border-right: 1px solid #9D9D9D;"><?php echo $trans->cancellation_till_charge; ?> AED</td>
-->
