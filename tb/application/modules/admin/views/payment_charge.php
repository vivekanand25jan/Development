...
<body>
 <div id="div_wrapper">
	...
	<li><a href="javascript:void(0)" style="border-radius:8px 0 0 0">Payment Charge</a></li>
...
<table width="50%"   border="0" cellspacing="1" cellpadding="6">
  <tr>
    <td style="background-color:#517BA5; color:#FFF">Amount in %</td>
 
    <td style="background-color:#517BA5; color:#FFF">Action</td>
  </tr>
 <form action="<?php echo site_url('index/edit_payment_gateway/'); ?>" method="post">
  <tr>
    <td><input type="text" name="charge" value="<?php echo $this->admin_model->get_payment_charge(); ?>" /></td>
