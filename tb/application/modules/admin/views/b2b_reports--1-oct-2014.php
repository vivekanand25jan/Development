  ...
  { 
	   for($i=0;$i<count($result_view);$i++)
	  {
	   ...
	   $cancel_for_dates = $result_view[$i]->cancel_for_dates;
           ...
           $net_for_admin = ($result_view[$i]->check_per==420)?array_sum(explode(',',$result_view[$i]->extra_service_admin)):0;
	...
	<td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $net_amount = ($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?($net_after_cancel+$net_for_admin):($namount)+$net_for_admin;?></td>
	...
	<td class="admin-table-colo-tab"><?php echo $result_view[$i]->voucher_date;?></td>
                  ...
                  <td style="background-color:#D3FEFA"  class="admin-table-colo-tab"><?php echo $net_amount = ($result_view[$i]->status=="Cancelled" && $result_view[$i]->cancelled_charge!='')?($net_after_cancel+$net_for_admin):($namount)+$net_for_admin;?></td><?php /* *$result_view[$i]->currency_val */ ?>
                  <td  style="background-color:#D3FEFA" class="admin-table-colo-tab"><?php echo $net_profit = ($aa-$net_amount); ?></td>
