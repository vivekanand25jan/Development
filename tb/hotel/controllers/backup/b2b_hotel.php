...
$this->session->set_userdata($newdata);
	...
	public function fetch_search_result() 
	{
		...
		/*echo json_encode(array(
			...
			$min_val = round($tmp_data['minVal']*$this->session->userdata('currency_value'));
...
$travco_cancel_policy .=  ' After:'.$dateToTimeVal[0].' '.$dateFromVal[1].' '.$cancelDescVal[1].'will be charged'.'<br>';							
	...
	if ($this->B2b_Hotel_Model->debitBookingAmount($agent_id,$branch_id,$value['amount'])) {
