...
<body>
<?php $this->load->view('header_agent'); ?>
<div class="midlebody">
              ...
              <tr>
                ...
                <td class="b2b-reg-cent-strip">
                	<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:15px; font-weight:bold; color:#FFF;">
                          <tr>
                            <td><font style=" font-size:25px; font-weight:normal; padding-left:8px;">Existing Agent, Login Here - </font></td>
                            <td>Agent Login :</td>
                            <td><input  value="<?php if( isset($login_email)) echo $login_email; ?>"  name="login_email"  type="text" class="b2b-txtbox-reg" style="background-color:#fff; width:170px; padding-left:4px; border-color:#badd00" />
                            											<div style="color:#FF0000;"> <?php echo form_error('login_email');?></div>
                                                                        </td>
                            <td>Password :</td>
                            <td><input  name="login_password" type="password" class="b2b-txtbox-reg" style="background-color:#fff; padding-left:4px; width:170px; border-color:#badd00" /></td>
          ...
          <tr>	
          	<td width="480" valign="top" style="border-right:2px dashed #989898;">
            	...
            	<table width="480" align="center" border="0" cellpadding="4" cellspacing="2">
                    <tr>
                      <td colspan="2" class="right-hotel-name" style=" font-size:25px; font-weight:normal; color:#243419; padding-top:0px; padding-bottom:15px">New Agent, Register Here</td>
                    </tr>
...
<?php echo form_error('name');?></td>
                    ...
                    <tr>
                     ...
                     <tr>
                      ...
                      <?php
					  $currency = $this->B2b_Model->get_currecy_detail();
                    ...
                    <tr>
                      <td class="right-hotel-name" colspan="2" style=" font-size:25px; font-weight:normal; color:#243419; padding-top:0px; padding-bottom:15px">Login Information</td>
                    </tr>
                    <tr>
            ...
            <td width="434" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            					...
            					<tr>
                                  <td align="center"><table align="center" width="421" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td width="421">
                                       <div style="border:1px #63701e solid; line-height:32px; border-radius:10px; margin-top:0px;">
                                        ...
                                        <div style="width:400px; margin:0 auto; padding:10px 0 10px 0">
                                        	<div class="right-hotel-name" style="font-size:17px; color:#243419; padding-top:0px; padding-bottom:15px">Benenfits include:</div>
