        ...
        <tr class='classic_room'>
            ...
            <td align='left' valign='middle' colspan="5" style="line-height:35px;font-size:13px;">
				...
				<?php 
					...
					if(!empty($get_hotel_promotion_stay_pay) && $stay_nights!='0' && !empty($pay_nights) && $pay_nights <= $counter && $stay_nights <= $days){ //echo $pay_nights; echo 'ccc'.$counter;
            ...
            <?php /*if(isset($hotel_room_cancel_policy->cancel_policy_from) && $hotel_room_cancel_policy->cancel_policy_from!=''){
				$cancel_policy_from = explode('-',$hotel_room_cancel_policy->cancel_policy_from);
            ...
            <?php if(isset($hotel_room_cancel_policy[0]->cancel_policy_from) && $hotel_room_cancel_policy[0]->cancel_policy_from!=''){					
				//echo $hotel_room_cancel_policy[0]->cancel_policy_nights;
				//echo $s_date;
            ...
            <!--Start of Remarks-->
            <?php if(isset($book_room_details[$j]->remarks) && $book_room_details[$j]->remarks!= ''){ ?>
            <?php echo $book_room_details[$j]->remarks; ?><br /> <?php } ?>            
            <!--End of Remarks-->
            
            <!--Start of Minimum Stay Nights-->   
            <?php if(isset($hotel_room_cancel_policy[0]->minimum_stay_nights) && $hotel_room_cancel_policy[0]->minimum_stay_nights!=''){ 
			 ...
			 ?> Minimum Stay Nights: <?php echo $hotel_room_cancel_policy[0]->minimum_stay_nights; ?> from <?php echo $hotel_room_cancel_policy[0]->minimum_stay_from; ?> to <?php echo $hotel_room_cancel_policy[0]->minimum_stay_to; ?><br /><?php } } ?>
            <!--End of Minimum Stay Nights--> 
            
            <!--Start of Cancellation Policy with rates-->
            <?php if(isset($book_room_details[$j]->cancel_policy_desc) && $book_room_details[$j]->cancel_policy_desc!= ''){ ?>
            <?php echo $book_room_details[$j]->cancel_policy_desc; ?><br /> <?php } ?>
