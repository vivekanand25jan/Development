...
?>
    ...
    <td align="left" valign="top" width="700">
		...
		$room_vecate_date = $end_date[2].'-'.$end_date[1].'-'.$end_date[0];
			...
			$prom_from=$get_hotel_promotion_stay_pay[0][0]->promotion_avail_date_from;
				 //echo "end".$end
			$prom_to=$get_hotel_promotion_stay_pay[0][0]->promotion_avail_date_to;
				if(!empty($get_hotel_promotion_stay_pay) && $dates_daily_prom >= $prom_from && $dates_daily_prom <= $prom_to && $pay_nights < $pay_count)
				{ //echo "hi";
				  if($checkfornight != '')
				  {
              ...
              $allocation_validty_from = $get_hotel_daily_allotment[0][0]->allocation_validity_from;
               ...
               //echo date("Y-m-d",$ainstrtime); echo "--";
                ...
                $alocto = strtotime($get_hotel_daily_allotment[0][0]->allocation_validity_to);
                 if(!empty($allocation_release_days) && $allocation_room_count > 0 && $strtoprice>=$ainstrtime) {
