...
*/
		...
		$("#slider-range, #slider-range-star").click(function () {
                                      ...
                                      <div class="wi159">
                                          <div class="arrow">
                                             ...
                                             <!-- <div class="price_rate"><span class="pw7">Star Rating:</span>: 150 € - 500 €</div>
                                                <div class="jq_bg"><img src="<?php echo WEB_DIR ?>images/jquery_img.jpg" width="140" height="17" /></div>-->
                                                <p><label for="star">Star Rating:</label>
...
<div><a href="#">Home</a> | <a href="#"><?php echo$_SESSION['city']; ?></a></div> 
<div class="wi584"><div id="result_count" style='float:left;'></div>&nbsp;Hotels Available on <?php echo$_SESSION['city']; ?>  </div>                                         
