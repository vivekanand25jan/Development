        ...
        <tr class='classic_room' width="700">
			...
			?>	
					<?php
						if($bodatec>$bodate){
					?>
            		A charge of <?php echo $this->session->userdata('currency_type').' ';?> <?php echo $per_all_nights_cancel_rate; ?> will apply if Cancelled or Amended for <?php echo $hotel_room_cancel_policy[$hcp]->cancel_policy_nights; ?> days prior to arrival.<br />
            		<?php }else{ ?>
            		A charge of <?php echo $this->session->userdata('currency_type').' ';?> <?php echo $per_all_nights_cancel_rate; ?> will apply if Cancelled or Amended for <?php echo $hotel_room_cancel_policy[$hcp]->cancel_policy_nights; ?> days prior to arrival.<br />
            		<?php } ?>
