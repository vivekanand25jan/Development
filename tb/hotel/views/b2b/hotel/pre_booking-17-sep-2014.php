...
$kk = $this->session->userdata('curr_values')*$total_cost;
		...
		$first_date = $room_alloc_date;
			...
			//print_r($allocation_room_count);exit;
				...
				<?php } $fd[2] = $fd[2] + $d; $counter++; array_push($stack, $valid); array_push($cancelsAmt, $total_cost);$c_child_above_age_charge=0;$c_sec_child_charge=0;} 
				//print_r($stack);
				//print_r($cancelsAmt);
				?>
            </td>
		...
		$grandBookCode.= $booking_code;
			...
			<?php echo $book_room_details[$j]->xml_currency;?> <?php echo $grand_total_cost*$this->session->userdata('curr_values'); //echo $book_room_details[$j]->total_cost;?><br /><!--<span style="color:green;">Available</span>-->
            <?php 
            ...
            <table border="0" cellpadding="1" cellspacing="1" bgcolor="#91a3b7" width="100%" style="font-size:11px;">
                    ...
                    <tr bgcolor="#DDDDDD">
                        ...
                        <td width="5%" align="center"><input type="checkbox" name="aeb" id="aeb_<?php echo $i.$j; ?>" value="aeb--<?php echo $totel1*$this->session->userdata('curr_values'); ?>" /></td>
                    </tr>
                    <tr bgcolor="#DDDDDD">
                        ...
                        <td width="5%" align="center"><input type="checkbox" name="cc" id="cc_<?php echo $i.$j; ?>" value="cc--<?php echo $totel2*$this->session->userdata('curr_values'); ?>" /></td>
                    </tr>
                    <tr bgcolor="#DDDDDD">
                        ...
                        <td width="5%" align="center"><input type="checkbox" name="caa" id="caa_<?php echo $i.$j; ?>" value="caa--<?php echo $totel3*$this->session->userdata('curr_values'); ?>" /></td>
                    </tr>
                    <tr bgcolor="#DDDDDD">
                        ...
                        <td width="5%" align="center"><input type="checkbox" name="ceb" id="ceb_<?php echo $i.$j; ?>" value="ceb--<?php echo $totel4*$this->session->userdata('curr_values'); ?>" /></td>
                    </tr>
                     <tr bgcolor="#DDDDDD">
                        ...
                        <td width="5%" align="center"><input type="checkbox" name="ampb" id="ampb_<?php echo $i.$j; ?>" value="ampb--<?php echo $totel5*$this->session->userdata('curr_values'); ?>" /></td>
                    </tr>
                     <tr bgcolor="#DDDDDD">
                        ...
                        <td width="5%" align="center"><input type="checkbox" name="ampl" id="ampl_<?php echo $i.$j; ?>" value="ampl--<?php echo $totel6*$this->session->userdata('curr_values'); ?>" /></td>
                    </tr>
                     <tr bgcolor="#DDDDDD">
                        ...
                        <td width="5%" align="center"><input type="checkbox" name="ampd" id="ampd_<?php echo $i.$j; ?>" value="ampd--<?php echo $totel7*$this->session->userdata('curr_values'); ?>" /></td>
                    </tr>
                     <tr bgcolor="#DDDDDD">
                        ...
                        <td width="5%" align="center"><input type="checkbox" name="cmpb" id="cmpb_<?php echo $i.$j; ?>" value="cmpb--<?php echo $totel8*$this->session->userdata('curr_values'); ?>" /></td>
                    </tr>
                     <tr bgcolor="#DDDDDD">
                        ...
                        <td width="5%" align="center"><input type="checkbox" name="cmpl" id="cmpl_<?php echo $i.$j; ?>" value="cmpl--<?php echo $totel9*$this->session->userdata('curr_values'); ?>" /></td>
                    </tr>
                    <tr bgcolor="#DDDDDD">
                        ...
                        <td width="5%" align="center"><input type="checkbox" name="cmpd" id="cmpd_<?php echo $i.$j; ?>" value="cmpd--<?php echo $totel10*$this->session->userdata('curr_values'); ?>" /></td>
                    </tr>
	    ...
	    $cancelPolicyPlan.='<br />'; } 
		 ...
		 $beCancelDateCharge.= $beCancelDate.'___'.$per_all_nights_cancel_rate.'//';
         } ?>
