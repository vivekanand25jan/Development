...
if($result != '')
{
	...
	{	
		...
		$sql="SELECT DISTINCT(allocation_rooms),allocation_release_days,allocation_validity_from FROM sup_inv_cate_allotment WHERE hotel_id='".$result[$i]->hotel_id."' AND cat_type='".$val1[0]."' AND season_id='".$season."' AND allocation_validity_date='".$priceDate."'";
