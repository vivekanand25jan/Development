...
$kk = $this->session->userdata('curr_values')*$total_cost;
		...
		//echo "<pre/>";print_r($get_hotel_promotion_stay_pay );
            ...
            <td align="center" valign="top" width="155" bgcolor="#eee" style="color:#966693; font-size:14px;"><?php echo $hotel_season_prices[$sp]->xml_currency;?> <?php echo $grand_total_cost*$this->session->userdata('curr_values'); //$hotel_season_prices[$sp]->total_cost;?> <br />
            <?php
        ...
        <tr class='classic_room' width="700">
			...
			?>	
					<?php
						if($bodatec>$bodate){
					?>
            		A charge of <?php echo $this->session->userdata('currency_type').' ';?> <?php echo $per_all_nights_cancel_rate*$this->session->userdata('curr_values'); ?> will apply if Cancelled or Amended for <?php echo $hotel_room_cancel_policy[$hcp]->cancel_policy_nights; ?> days prior to arrival.<br />
            		<?php }else{ ?>
            		A charge of <?php echo $this->session->userdata('currency_type').' ';?> <?php echo $per_all_nights_cancel_rate*$this->session->userdata('curr_values'); ?> will apply if Cancelled or Amended for <?php echo $hotel_room_cancel_policy[$hcp]->cancel_policy_nights; ?> days prior to arrival.<br />
            		<?php } ?>
