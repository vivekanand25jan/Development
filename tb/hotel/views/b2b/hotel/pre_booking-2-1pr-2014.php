...
//echo "<pre/>";print_r($book_room_details);exit;
        ...
        <tr class='classic_room'>
            ...
            <?php if(!empty($get_hotel_promotion_stay_pay)){ //echo "hello";
				if(($get_hotel_promotion_stay_pay[0][0]->stay_nights!='' && $counterdays >= $get_hotel_promotion_stay_pay[0][0]->stay_nights && $get_hotel_promotion_stay_pay[0][0]->stay_nights!='0') || $get_hotel_promotion_stay_pay[0][0]->bb_date!='0000-00-00'){
					//echo "hi";exit;
		$special_offer.='<div><img src="'.WEB_DIR.'images/promotion.gif" /> 
                ...
                if($get_hotel_promotion_stay_pay[0][0]->stay_nights!='' && $counterdays >= $get_hotel_promotion_stay_pay[0][0]->stay_nights && $get_hotel_promotion_stay_pay[0][0]->stay_nights!='0' ) { 
            ...
            <table border="0" cellpadding="1" cellspacing="1" bgcolor="#91a3b7" width="100%" style="font-size:11px;">
                    ...
                    <tr bgcolor="#DDDDDD">
                        ...
                        <?php  
							...
							echo number_format((float)$totalForEbp, 2, '.', '');
                    ...
                    <tr bgcolor="#DDDDDD">
                        ...
                        <?php  
							...
							echo number_format((float)$totalForCc, 2, '.', '');
                    ...
                    <tr bgcolor="#DDDDDD">
                        ...
                        <?php  
							...
							echo number_format((float)$totalForCag, 2, '.', '');
                    ...
                    <tr bgcolor="#DDDDDD">
                        ...
                        <?php  
							...
							echo number_format((float)$totalForCebg, 2, '.', '');
                     ...
                     <tr bgcolor="#DDDDDD">
                        ...
                        <?php  
							...
							echo number_format((float)$totalForampbr, 2, '.', '');
                     ...
                     <tr bgcolor="#DDDDDD">
                        ...
                        <?php  
							...
							echo number_format((float)$totalForamplr, 2, '.', '');
                     ...
                     <tr bgcolor="#DDDDDD">
                        ...
                        <?php  
							...
							echo number_format((float)$totalForampdr, 2, '.', '');
                     ...
                     <tr bgcolor="#DDDDDD">
                        ...
                        <?php  
							...
							echo number_format((float)$totalForcmpbr, 2, '.', '');
                     ...
                     <tr bgcolor="#DDDDDD">
                        ...
                        <?php  
							...
							echo number_format((float)$totalForcmplr, 2, '.', '');
                    ...
                    <tr bgcolor="#DDDDDD">
                        ...
                        <?php  
							...
							echo number_format((float)$totalForcmpdr, 2, '.', '');
 ...
 <table align="left" width="724" border="0" cellspacing="5" cellpadding="5" class="sum-txt" style="margin-top:15px; border:1px #227fb0 solid; border-radius:10px;">
      ...
      <tr>
        ...
        <td> <textarea height="50" width="100" name="request"></textarea></td>
		 ...
		 <!-- ends -->
   <div style="float:left; width:700px;margin-bottom: 10px;"> <input type="checkbox" name="terms" /> A agree <a href="http://travel-bay.com/travelbay/index.php/home/terms" class="text3" target="light_box" onclick="$('#lightbox').show();" style="color:#06C;">Terms and Conditions</a> of agency. </div>
    <?php
