...
<span>Thank  you for booking your hotel with Travel Bay. Confirmation pending due to non payment. <br />Once reach the cancellation till date, automatically cancelled in this booking. So if you want avoid the cancellation process then you will pay to the admin within cancellation till date.<br /><font color="#FF0000"> Deadline is  <?php echo $trans->cancellation_till_date; ?>.</font>
<br /><br /> We are pleased to confirm your booking details as below:</span></td>
          </tr>
           <?php
    ...
    <tr>
     <td align="left">
        <div style="width:700px; margin:0 auto;">
            ...
            <img src="<?php echo $hotel_image; ?>" border="0" width="120" height="100" />
            </div>-->
      ...
      <tr>
         <td align="left">
         	<div style="width:700px; margin:0 auto;">
            	...
            	<div class="hotelfa-div" style="border:none">
            	<div style="float:left;"><?php if(isset($result_view->special_offer) && $result_view->special_offer!=''){ echo $result_view->special_offer; } ?></div>
                </div>
