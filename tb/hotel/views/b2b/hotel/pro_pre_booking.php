...
<div class="midlebody">
  ...
  <div class="serachbar1">
   ...
   <div>
    ...
    <form name="book" action="<?php print WEB_URL.'b2b_hotel/pre_booking/'.$result_id; ?>" method="post" onsubmit="javascript:return book_vali()"/>
                                 <table width="100%" border="0" style=""  cellspacing="2" cellpadding="6">
                          <tr>
                          <td bgcolor="#E9E9E9" style="padding: .3em; border: 1px #ccc solid;" ></td>
                          <td bgcolor="#E9E9E9" style="padding: .3em; border: 1px #ccc solid;font-weight: bold;" >Room Type</td>
                          <td bgcolor="#E9E9E9" style="padding: .3em; border: 1px #ccc solid;font-weight: bold;" >Inclusion</td>
                          <td bgcolor="#E9E9E9" style="padding: .3em; border: 1px #ccc solid;font-weight: bold;" >Night</td>
				    <td bgcolor="#E9E9E9" style="padding: .3em; border: 1px #ccc solid;font-weight: bold;" >Cost</td>
                          <td bgcolor="#E9E9E9" style="padding: .3em; border: 1px #ccc solid;font-weight: bold;" >Status</td>
                                </tr>
                                <?php
      ...
      <td style="padding: .3em; border: 1px #ccc solid;">
                    ...
                    ?></td>
                     ...
                     <?php   	
								...
								?>
                                <tr>
                                <td align="right" colspan="7"><input type="image" src="<?php echo WEB_DIR; ?>images/bookin-img.jpg" border="0" /> </td></tr>
                                </table>
                                </form>
