            ...
            <td align='left' valign='middle' colspan="5" style="line-height:35px;font-size:13px;">
				...
				/* EARLYBIRD CODE BY VIVEK */
					...
					if(isset($get_hotel_early_bird_rates[0]->discount) && $get_hotel_early_bird_rates[0]->discount!= '')
					{
						...
						$total_costwm = $get_hotel_daily_rates[0]->rate - $discount_amt;
				...
				/* EARLYBIRD CODE END BY VIVEK */

					
					//$amountv1 = $roomPlusSupplementCharge=$total_cost + $get_hotel_daily_rates[0]->supplementary_charge_rate;
...
$kk = $this->session->userdata('curr_values')*$total_cost;
	    ...
	    $cancelPolicyPlan.='<br />'; } 
		 ...
		 $cancelPolicyPlan.=number_format((float)$per_all_nights_cancel_rate*$this->session->userdata('curr_values'), 2, '.', ''); 
        ...
        <tr class='' width="100">
            ...
            <input id="totalValues" name="totalValues" type="hidden" value="<?php echo number_format((float)$totalValue, 2, '.', ''); ?>" />
