...
<?php $star = $service->star; 
          ...
          <tr>
          	<td style="color:#966693"><?php echo $service->address."., ".$service->city; ?><br />
Tel: <?php echo $service->phone; ?> Fax: <?php echo $service->fax; ?></td>
          ...
          <?php } ?>
            <tr style="color:#FFF;" height="35">
                <td width="74%">&nbsp;</td>
                <td width="12%" align="center" valign="middle" bgcolor="#606d1e"><b>Available</b></td>
                <td width="12%" align="center" valign="middle" bgcolor="#ff9900"><b>On Request</b></td>
            </tr>
            </table>
...
<tr class='classic_room'>
            <td align='left' valign='middle' width="120" bgcolor="#eee" style="color:#227FB0; font-size:14px;">
            Season: <?php $season_name = $this->B2b_Hotel_Model->get_season($hotel_season_prices[$sp]->season); echo $season_name->season;?><br/><br/>
            Market: <?php $market_name = $this->B2b_Hotel_Model->get_market($hotel_season_prices[$sp]->market_id); echo $market_name->market_name; ?>
            </td>
            <!--<td align="center" valign="middle" width="170" bgcolor="#eee" style="color:#227FB0; font-size:14px;">Market:<br /> <?php $market_name = $this->B2b_Hotel_Model->get_market($hotel_season_prices[$sp]->market_id); echo $market_name->market_name; ?></td>-->
            <td align="center" valign="middle" width="370" bgcolor="#eee" style="color:#966693; font-size:14px;"><!--<?php echo $hotel_season_prices[$sp]->xml_currency;?> <?php echo $hotel_season_prices[$sp]->total_cost;?> <br /><span style="color:green;">Available</span>-->
            ...
            <table border="0" cellpadding="1" cellspacing="1" bgcolor="#91a3b7" width="100%" style="font-size:11px;">
                    ...
                    <tr bgcolor="#DDDDDD">
                        <td valign="middle" align="center" rowspan="1" nowrap bgcolor="#ffffff"> <font class="home-text"><?php $roomType = explode('-',$hotel_season_prices[$sp]->room_type); echo $roomType[1];?></font> </td>
                        <td align="center" valign="middle" height="20" bgcolor="#ffffff"> <font class="home-text"><font color="#282828">&nbsp;wk1</font></font> </td>
                        <?php 
						 $counter1=0;
						for($d=0;$d < $days;$d++)
                        { 
                           if($counter1 < 7 ) { 
                        ?>
                        <td align="center" valign="middle" height="5" bgcolor="#ff9900"> <font color="#FFFFFF"><b>
                        <?php  
                               $first_date = $room_alloc_date;
                               $fdate = $first_date; 
                               $fd = explode("-", $fdate); 		
                               $bdate = date("Y-m-d", mktime(0,0,0,$fd[1], $fd[2] + $d, $fd[0]));
							   echo $hotel_season_prices[$sp]->total_cost;
                        ?></b></font></td>
                        <?php } $fd[2] = $fd[2] + $d; $counter1++; } ?>
                        <?php for($r=0;$r<(7 - $d);$r++) {  $fd[2] = $fd[2]+1;?>
                        <td align="center" valign="middle" height="5" bgcolor="#ffffff"> <font color="#FFFFFF"><b>
                        <?php 
                        //echo date("D", mktime(0,0,0,$fd[1], $fd[2], $fd[0])); ?> </b></font></td><?php } ?>
                        <td width="8%" bgcolor="#ffffff" align="center"><font class=small1><font color="#282828"><b>1306</b></font></font></td>
                    </tr>
                    <tr bgcolor="#DDDDDD">
                        <td valign="middle" align="center" rowspan="1" nowrap bgcolor="#ffffff"> <font class="home-text">Adult Extra Bed</font> </td>
                        <td align="center" valign="middle" height="20" bgcolor="#ffffff"> <font class="home-text"><font color="#282828">&nbsp;wk1</font></font> </td>
                        <td align="center" valign="middle" height="5" bgcolor="#ff9900"> <font color="#FFFFFF"><b>653</b></font></td>
                        <td align="center" valign="middle" height="5" bgcolor="#606d1e"> <font color="#FFFFFF"><b>653</b></font></td>
                        <td bgcolor=#ffffff><font>&nbsp;</font></td><td bgcolor=#ffffff><font >&nbsp;</font></td>
                        <td bgcolor=#ffffff><font >&nbsp;</font></td><td bgcolor=#ffffff><font>&nbsp;</font></td>
                        <td bgcolor=#ffffff><font >&nbsp;</font></td>
                        <td width="8%" bgcolor="#ffffff" align="center"><font class=small1><font color="#282828"><b>1306</b></font></font></td>
                    </tr>
                    <tr bgcolor="#DDDDDD">
                        <td valign="middle" align="center" rowspan="1" nowrap bgcolor="#ffffff"> <font class="home-text">Child Charge</font> </td>
                        <td align="center" valign="middle" height="20" bgcolor="#ffffff"> <font class="home-text"><font color="#282828">&nbsp;wk1</font></font> </td>
                        <td align="center" valign="middle" height="5" bgcolor="#ff9900"> <font color="#FFFFFF"><b>653</b></font></td>
                        <td align="center" valign="middle" height="5" bgcolor="#606d1e"> <font color="#FFFFFF"><b>653</b></font></td>
                        <td bgcolor=#ffffff><font>&nbsp;</font></td><td bgcolor=#ffffff><font >&nbsp;</font></td>
                    ...
                    <tr bgcolor="#DDDDDD">
                        <td valign="middle" align="center" rowspan="1" nowrap bgcolor="#ffffff"> <font class="home-text">Child Above 6 Age</font> </td>
                        <td align="center" valign="middle" height="20" bgcolor="#ffffff"> <font class="home-text"><font color="#282828">&nbsp;wk1</font></font> </td>
                        <td align="center" valign="middle" height="5" bgcolor="#ff9900"> <font color="#FFFFFF"><b>653</b></font></td>
                        <td align="center" valign="middle" height="5" bgcolor="#606d1e"> <font color="#FFFFFF"><b>653</b></font></td>
                        <td bgcolor=#ffffff><font>&nbsp;</font></td><td bgcolor=#ffffff><font >&nbsp;</font></td>
                    ...
                    <tr bgcolor="#DDDDDD">
                     ...
                     <tr bgcolor="#DDDDDD">
          			...
          			<tr bgcolor="#FFFFFF"  align="center" bordor=no>
            ...
            <td align="center" valign="middle" width="20" bgcolor="#eee">
        ...
        <tr class='classic_room' width="700">
            ...
            <?php if(isset($hotel_room_cancel_policy->cancel_policy_from) && $hotel_room_cancel_policy->cancel_policy_from!=''){if($hotel_room_cancel_policy->cancel_policy_from >= $s_date){ ?>
            <div style='color:red;font-weight:bold;'>Deadline Under Cancellation</div> <?php }} ?>
            <!--Start of Cancel Deadline--> 
...
<table width="100%" border="0" cellspacing="10" cellpadding="0" class="hotelnames" style="margin-bottom:3px;border: 1px solid #BEE7FF;">
    <tr>
        ...
        <td width="25%" align="center" style="font-size:15px;color:#966693; font-size:14px;" id="resultTotal">&nbsp;</td>
