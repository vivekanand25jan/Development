...
//echo 'l';
		...
		//echo "<pre/>";print_r($get_hotel_promotion_stay_pay );
			...
			if(!empty($get_hotel_promotion_stay_pay) && $counterdays >= $get_hotel_promotion_stay_pay[0][0]->stay_nights){ //echo "hi";
				if(($get_hotel_promotion_stay_pay[0][0]->stay_nights!='' && $counterdays >= $get_hotel_promotion_stay_pay[0][0]->stay_nights && $get_hotel_promotion_stay_pay[0][0]->stay_nights!='0') || $get_hotel_promotion_stay_pay[0][0]->bb_date!='0000-00-00'){ //echo "hello";
			?>
                ...
                <?php } ?>
                <?php if($get_hotel_promotion_stay_pay[0][0]->stay_nights!='' && $counterdays >= $get_hotel_promotion_stay_pay[0][0]->stay_nights && $get_hotel_promotion_stay_pay[0][0]->stay_nights!='0' ) { ?>
