...
//echo "<pre/>";print_r($book_room_details);exit;
        ...
        <tr class='classic_room'>
            ...
            <td align='left' valign='middle' colspan="5" style="line-height:35px;font-size:13px;">
				...
				$prom_to=$get_hotel_promotion_stay_pay[0][0]->promotion_avail_date_to;
					...
					echo "<br/>";
					echo "allocation_release_days";
					echo $allocation_release_days = $get_hotel_daily_allotment[0]->allocation_release_days;
					...
					echo $expiration_date = strtotime($exp_date); echo "hhh";die;
		...
		$grandBookCode.= $booking_code;
            ...
            <?php 
				if (in_array("On Request", $stack)) { echo "jjj";
