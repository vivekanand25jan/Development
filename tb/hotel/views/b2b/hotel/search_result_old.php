...
$con =  strtr(base64_encode($city[1]),array('+' => '.','=' => '-','/' => '~'));										?>	
    ...
    <div style="width:600px; float:left;"><h1><div id="result_count" style='float:left;'></div>
    &nbsp; Hotels Availables in <?php echo$_SESSION['city']; ?> </h1></div>
    <div style="width:100px; float:right; margin-top:20px; font-family:MAIAN;"><img src="<?php echo WEB_DIR; ?>images/map_icon.png" width="22" height="22" align="top" /> <a style="color:#06F; text-decoration:none;" href="<?php print WEB_URL.'b2b_hotel/mapping_fun_all/'; ?> "  onclick="$('#rlightbox').show();" target="rlight_box" class="text3">Showmap</a></div>
...
lii:hover lii a:hover { background: #95A9B1; }
 ...
 Currency
    ...
    <div class="nextpage"><div class="pagination" style="line-height:17px; padding-top:0px; padding-left:4px; margin-top:-14px;">
             <div class="data"></div>
