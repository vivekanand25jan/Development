...
<div class="midlebody">
    ...
    <div class="hotelnames_signin" style="min-height:329px;">
   		...
   		<!--<div class="right-hotel-name">Youngor Central Suzhou</div>--><div id="mybook-tit">  <?php  echo 'Branch Deposit Request'; ?>   <span style="float:right"><a href="<?php echo WEB_URL; ?>b2b/agent_profile"><img src="<?php echo WEB_DIR;?>images/b2b-back-but.png" /></a></span></div>
   
        <div class="">     
           		
<!-- the tabs -->
<form action="<?php echo WEB_URL.'b2b/add_branch_deposit_process'; ?>" method="post"  name="reg" >
        		...
        		<div class="tb_sample_cover_thre">
                		<div class="tb_sample_cover_thre_L"> Amount :</div>
                        <div class="tb_sample_cover_thre_R"><input class="agent_text_cover_txt_feil" name="amount" type="text" value="<?php if( isset($amount)) echo $amount; ?>" />
						<div style="color:#FF0000;"><?php if(isset($exist)) { echo $exist; } ?> <?php echo form_error('amount');?></div>
						</div>
                </div>
