...
<table width="920" border="0" align="left" cellpadding="0" cellspacing="0" style="margin:15px 0 0 15px; border:1px solid #ccc;">
  ...
  for($i=0;$i<count($result);$i++)
  {
	  ...
	  $namountmar = ($result[$i]->status=="Cancelled" && $result[$i]->cancelled_charge!='')?($result[$i]->amount+$result[$i]->agent_markup)-$result[$i]->cancelled_charge:$result[$i]->amount+$result[$i]->agent_markup;
  ?>
  <tr>
    ...
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php echo $namount; ?> </td>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php echo $namountmar; ?> </td>
