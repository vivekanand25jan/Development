...
<body>
		...
		<form action="<?php echo WEB_URL.'b2b/edit_branch_markup/'.$result->markup_id; ?>" method="post"  name="reg" >
        		...
        		<div class="tb_sample_cover_thre">
                        ...
                        <div class="tb_sample_cover_thre_R"><input class="agent_text_cover_txt_feil" name="markup" type="text" value="<?php if( isset($result->markup)) echo $result->markup; ?>" />
				...
				<input type="hidden" name='markup_id' value="<?php echo $result->markup_id; ?>">
