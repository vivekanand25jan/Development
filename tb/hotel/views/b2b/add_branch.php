...
<div class="midlebody">
    ...
    <div class="hotelnames_signin" style="min-height:329px;">
   		...
   		<!--<div class="right-hotel-name">Youngor Central Suzhou</div>--><div id="mybook-tit">  <?php if($status!=''){ echo $status; } else { echo 'Add New Branch'; }?>   <span style="float:right"><a href="<?php echo WEB_URL; ?>b2b/agent_profile"><img src="<?php echo WEB_DIR;?>images/b2b-back-but.png" /></a></span></div>
...
<form action="<?php echo WEB_URL.'b2b/add_branch'; ?>" method="post"  name="reg" >
        ...
        <div class="tb_sample_cover_thre">
                        ...
                        <div class="tb_sample_cover_thre_R"><input type="image" src="<?php echo WEB_DIR ?>images/save_btn.jpg" width="75" height="35" /></div>
          </div>
		  </form>
