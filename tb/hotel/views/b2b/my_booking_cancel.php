...
<div class="midlebody">
    ...
    <div class="hotelnames_signin" style="min-height:329px;">
   		...
   		<!--<div class="right-hotel-name">Youngor Central Suzhou</div>--><div id="mybook-tit">Cancelled Booking</div>
...
<table width="920" border="0" align="left" cellpadding="0" cellspacing="0" style="margin:15px 0 0 15px; border:1px solid #ccc;">
  ...
  ?>
  <tr>
    <td align="left" valign="top" class="my_profile_name_ex_tab_whit"><?php echo $result[$i]->prn_no; ?></td>
