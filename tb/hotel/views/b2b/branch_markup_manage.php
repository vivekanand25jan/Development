...
function deleteConform(markup_id) {

	if (confirm("Are you sure you want to delete this staff?"))
	{
		
		$.ajax({
		  url:'<?php echo WEB_URL; ?>b2b/delete_branch_markup/'+markup_id,
		  data: '',
		  dataType: "json",
		  success: function(result){
			if (result == 'success') {
				window.location = '<?php echo WEB_URL; ?>b2b/branch_markup_manage/';
			}
		  }
		 });
		...
		<div class="tb">
					...
					for($i=0;$i< count($result);$i++) { ?>
						<div class="tb_sample_cover211">
                            ...
                            <div class="tr_col_01"><a href="<?php echo WEB_URL . 'b2b/edit_branch_markup/'.$result[$i]->markup_id; ?>">Edit</a> | <a href="#" onclick='deleteConform(<?php echo $result[$i]->markup_id; ?>);'>Delete</a></div>
			...
			<div class="add_new_btn"><a href="<?php echo WEB_URL; ?>b2b/add_branch_markup/"><input type="image" src="<?php echo WEB_DIR ?>images/add_new_btn.jpg" width="109" height="35" /></a></div>
