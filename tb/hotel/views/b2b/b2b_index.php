...
<div class="midlebody">
  ...
  if($agent_det->agent_mode != 'cash')
  {
  	...
  	<div class="b2b_left-secbox">
  		<div style="width:220px; margin:0 auto; font-family:MAIAN; font-size:15px" >
        	<div class="account_body">
					...
					<span style="float:left; width:100px; font-weight:bold;"> Balance </span> :  <?php echo $this->session->userdata('currency_type').' '.$balance_credit; ?><br/>
   <span style="float:left; width:100px; font-weight:bold;"> Last Credit </span>         :  <?php if (isset($last_credit)) echo $this->session->userdata('currency_type').' ' . $last_credit; ?><br/>
				<?php 
				}
				else
				{
				?>
                <span style="float:left; width:100px; font-weight:bold;"> Balance </span> :  <?php echo $this->session->userdata('currency_type').' ';?> 0<br/>
   <span style="float:left; width:100px; font-weight:bold;"> Last Credit </span>         :  <?php echo $this->session->userdata('currency_type').' ';?> 0<br/>
                <?php
				}
				?>
   ...
   : ?>
	...
	{ echo $branch_acc_info[$i]->balance_credit;  } else { echo '0 '.$this->session->userdata('currency_type'); }?><br/>
	<span style="float:left; width:100px; font-weight:bold;"> Last Credit </span>         :  <?php if($branch_acc_info[$i]->balance_credit != '') { echo $branch_acc_info[$i]->last_credit;  } else { echo '0 '.$this->session->userdata('currency_type'); }?><br/>
    <span style="float:left; width:100px; font-weight:bold;"> ---------------------------------</span> <br /> 
    ...
    <div class="b2b-leftdiv-toptit"><span>Notice Board</span></div>
  	<div class="b2b_left-secbox">
  		<div style="width:200px; margin:0 auto;">
			...
			if(!empty($agent_offers[0]->offer_content) && $agent_offers[0]->offer_content!='')
