...
<div class="midlebody">
    ...
    <div class="hotelnames_signin" style="min-height:329px;">
   		...
   		<!--<div class="right-hotel-name">Youngor Central Suzhou</div>--><div id="mybook-tit">  <?php if($status!=''){ echo $status; } else { echo 'Add New Staff'; }?>   <span style="float:right"><a href="<?php echo WEB_URL; ?>b2b/agent_profile"><img src="<?php echo WEB_DIR;?>images/b2b-back-but.png" /></a></span></div>
   
        <div class="">     
           		
<!-- the tabs -->
<form action="<?php echo WEB_URL.'b2b/add_staff'; ?>" method="post"  name="reg" >
        		...
        		<div class="tb_sample_cover_thre">
                        ...
                        <div class="tb_sample_cover_thre_R"><input class="agent_text_cover_txt_feil" name="staff_name" type="text" value="<?php if( isset($staff_name)) echo $staff_name; ?>" />
						<div style="color:#FF0000;"> <?php echo form_error('staff_name');?></div>
						</div>
                </div>
                <div class="tb_sample_cover_thre">
                		<div class="tb_sample_cover_thre_L"> Email : </div>
                        <div class="tb_sample_cover_thre_R"><input class="agent_text_cover_txt_feil" name="email_id" type="text" value="<?php if( isset($email_id)) echo $email_id; ?>" />
				...
				<div class="tb_sample_cover_thre">
                        ...
                        <div class="tb_sample_cover_thre_R"><input class="agent_text_cover_txt_feil" name="comform_password" type="password" />
						<div style="color:#FF0000;"> <?php echo form_error('password');?>
						</div>
                </div>
				</div>
