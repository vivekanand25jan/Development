...
<div class="for_loop">
                                      ...
                                      <div class="wi565">
                                      		<div class="wi565a">
                                            	<div class="wi407"><span class="sp_pad"><?php echo $result[$i]->api.' -'.$result[$i]->hotel_name; ?></span>
											   ...
											   ?>
                                                </span><br/><br/><span><span class="fw"><?php echo $result[$i]->city; ?></span> /<span class="fw01"><a href="javascript:searchLocationsNear(<?php echo $result[$i]->api_temp_hotel_id; ?>);" > 
    Show Map</a></span></span>
            ...
            <img  width="25"  src="<?php echo WEB_DIR.'images/mouse.png'; ?>" />
            ...
            <img  width="25"  src="<?php echo WEB_DIR.'images/pp-icons-restaurant.png'; ?>" />
