...
<p>Welcome <?php echo $this->session->userdata('name'); ?> <span class="travel_signin_space">|</span>   <a href="<?php echo WEB_URL; ?>b2b/logout/" class="sign_up_link">Log Out</a><span class="travel_signin_space">|</span> <?php  if($agent_det_all->agent_mode!='cash') { if (isset($balance_credit)) { ?> <?php echo $this->session->userdata('currency_type').' '.$balance_credit; } else { echo $this->session->userdata('currency_type')." 0"; } } ?> <span class="travel_signin_space">|</span>   <a href="#">Feedback</a></p>
</div>
...
<div class="travelbay_logo"><a href="<?php echo WEB_URL; ?>b2b/agent_page/"><img src="<?php echo WEB_DIR; ?>designAccess/images/arahmb.png" width="310" height="68" border="0" /></a></div>
