<!--<a href="#">Agent</a> <span class="travel_signin_space">|</span>   <a href="#">Feedback</a></p>-->
</div>
...
<div class="travelbay_logo"><a href="<?php echo WEB_URL; ?>"><img src="<?php echo WEB_DIR; ?>designAccess/images/arahmb.png" width="310" height="68" border="0" /></a></div>
<div class="travel_sndiv">
<div class="travel_sn"><span style="position:relative; top:-12px;">Follow us:</span> <a target="_blank" href="http://www.facebook.com/arahmb"><img src="<?php echo WEB_DIR; ?>designAccess/images/sn_icons-fb.jpg" border="0" /></a><a target="_blank" href="http://www.twitter.com/arahmb"><img src="<?php echo WEB_DIR; ?>designAccess/images/sn_icons1.jpg" border="0" /></a><img src="<?php echo WEB_DIR; ?>designAccess/images/sn_icons21.jpg" border="0" /></div>
<div class="travel_sn1"><img src="<?php echo WEB_DIR; ?>designAccess/images/phone_icon.png" width="11" height="31" border="0" style="position:relative; top:5px;" /> <span style="font-size:25px; font-weight:bold;">+91 7369043729</span></div>
</div>
</div>
<!--top banner end here-->
...
<li><div><img src="<?php echo WEB_DIR; ?>designAccess/images/nav_line.png" width="1" height="45" border="0" /></div></li>
<li><a href="<?php echo WEB_URL; ?>b2b/login" target="_blank" >BECOME AGENT</a></li>
<li><div><img src="<?php echo WEB_DIR; ?>designAccess/images/nav_line.png" width="1" height="45" border="0" /></div></li>
...
<style>
.close_btn {
    background: url("<?php echo WEB_DIR; ?>images/Close-button1.png") no-repeat scroll 0 0 transparent;
    display: block;
    height: 42px;
    left: 507px;
    position: relative;
